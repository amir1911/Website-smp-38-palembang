...
<section class="py-16 bg-gradient-to-br from-[#E8F5FF] to-[#F9FCFF] font-[Poppins] min-h-screen">
  <div class="max-w-6xl mx-auto px-6">

    <!-- Judul -->
    <div class="text-center mb-12" data-aos="fade-down">
        <h1 class="text-3xl md:text-4xl font-extrabold text-[#49ADFF] tracking-tight">
            🔍 Hasil Pencarian
        </h1>
    ...
    @else
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            @foreach($results as $item)
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition transform hover:-translate-y-2 duration-500" data-aos="zoom-in">
                    <div class="relative flex items-center justify-center bg-gray-50 h-56">
                        ...
                        <!-- Label tipe -->
                        <div class="absolute top-3 right-3 bg-[#49ADFF] text-white text-xs px-3 py-1 rounded-full shadow-md">
                            {{ $item->tipe }}
                        </div>
                    </div>
                    <div class="p-5 text-center">
                        <h3 class="text-lg font-semibold text-[#49ADFF] mb-2">
                            {{ $item->judul }}
                        </h3>
