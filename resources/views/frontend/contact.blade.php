...
<style>
    /* Background geometris lembut */
    .geometric-bg {
        background-image: 
            radial-gradient(circle at 20% 20%, rgba(73,173,255,0.08) 0%, transparent 60%),
            radial-gradient(circle at 80% 80%, rgba(73,173,255,0.08) 0%, transparent 60%),
            radial-gradient(circle at 50% 50%, rgba(73,173,255,0.04) 0%, transparent 70%);
    }
</style>

<section class="py-20 geometric-bg bg-gradient-to-br from-[#E8F5FF] to-[#F9FCFF] font-[Poppins]">
    <div class="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">

        {{-- ==================== INFORMASI & GOOGLE MAP ==================== --}}
        <div class="lg:col-span-3 space-y-8 order-2 lg:order-1" data-aos="fade-right">
            <h3 class="text-3xl font-bold text-[#2C8BEF] mb-3">Alamat Sekolah</h3>
            ...
            {{-- Google Map --}}
            <div class="rounded-2xl overflow-hidden shadow-md border border-gray-200 hover:shadow-xl transition duration-500">
                <iframe 
        ...
        {{-- ==================== FORM KONTAK ==================== --}}
        <div class="lg:col-span-2 bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition duration-500 order-1 lg:order-2" data-aos="fade-left">
            <h2 class="text-2xl font-bold mb-4 text-[#2C8BEF]">Kontak Kami</h2>
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="space-y-3">
                ...
                <button type="submit" 
                    class="bg-[#2C8BEF] w-full text-white py-2.5 rounded-full font-semibold text-sm hover:bg-[#1f7bd6] active:scale-95 transition duration-300">
                    Kirim Pesan ✉️
                </button>
            </form>
            ...
            <div class="flex justify-center space-x-6 mt-6">
                <a href="#" class="text-[#2C8BEF] hover:text-[#1f7bd6] text-xl transition"><i class="fab fa-facebook-f"></i></a>
