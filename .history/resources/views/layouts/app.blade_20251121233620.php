...
<header :class="scrolled ? 'navbar-scrolled' : 'bg-primary'" class="shadow-md sticky top-0 z-50 transition-all duration-500">
    ...
    <div x-data="{ dropProfil: false }" class="space-y-2">
        ...
        <div x-show="dropProfil" x-transition
            ...
            <a href="/visi" class="block px-5 py-3 text-sm hover:bg-white/20 border-b border-white/10">
                <i class="fas fa-eye mr-2"></i> Visi
            </a>
            <a href="/visimisi" class="block px-5 py-3 text-sm hover:bg-white/20">
    ...
    <div x-data="{ guruOpen: false }" class="space-y-2">
        ...
        <div x-show="guruOpen" x-transition
             class="bg-white/10 rounded-xl overflow-hidden ml-4 shadow-inner">
            ...
            <a href="{{ route('guru.staff') }}"
               class="block px-5 py-3 text-sm hover:bg-white/20">
                Staff
            </a>
        </div>
    </div>
