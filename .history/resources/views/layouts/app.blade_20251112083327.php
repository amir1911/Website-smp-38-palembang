  ...
  <header 
    ...
    <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-1 items-center text-sm font-semibold">
        ...
        <a href="/profile" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow">
        ...
        <div x-data="{ drop: false }" class="relative">
          ...
          <div x-show="drop" 
            ...
            <a href="{{ route('pengumuman.index') }}" 
               class="block px-5 py-3 text-gray-700 hover:bg-blue-50 font-medium transition-all border-b border-gray-100">
        ...
        <a href="/guru" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow">
          <i class="fas fa-chalkboard-teacher mr-1.5"></i>GURU & STAFF
        </a>
        <a href="/contact" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow">
      ...
      <form action="{{ route('search') }}" method="GET" class="hidden md:flex items-center space-x-2">
        <div class="relative">
          <input type="text" name="q" placeholder="Cari..." 
                 class="pl-11 pr-4 py-2.5 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white/50 bg-white w-44 focus:w-60 transition-all shadow-lg" required>
    ...
    <div x-show="open" 
      ...
      <div x-data="{ drop: false }" class="space-y-2">
        ...
        <div x-show="drop" 
             x-transition
             class="bg-white/10 rounded-xl overflow-hidden ml-4 shadow-inner">
          <a href="{{ route('pengumuman.index') }}" 
             class="block px-5 py-3 hover:bg-white/20 text-sm border-b border-white/10 transition">
      ...
      <form action="{{ route('search') }}" method="GET" class="pt-4 border-t border-blue-200">
        <div class="relative">
          <input type="text" name="q" placeholder="Cari..." 
                 class="w-full pl-12 pr-4 py-3.5 rounded-full text-gray-700 focus:outline-none focus:ring-2 focus:ring-white shadow-lg" required>
          <i class="fas fa-search absolute left-5 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg"></i>
        </div>
        <button type="submit" 
                class="mt-3 w-full bg-white text-primary py-3.5 rounded-full font-bold hover:bg-yellow-300 hover:text-primary-dark transition shadow-lg hover-lift">
    ...
    <div class="border-t border-white/30 pt-8">
      <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-sm">
        ...
        <p class="text-center text-white/95">
          Dibuat dengan <i class="fas fa-heart text-red-400 mx-1"></i> oleh <b class="text-white font-bold">Kelompok 3 RPL</b> | @2025
        </p>
      </div>
    </div>
  </footer>
