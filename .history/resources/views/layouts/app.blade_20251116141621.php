...
<header :class="scrolled ? 'navbar-scrolled' : 'bg-primary'" class="shadow-md sticky top-0 z-50 transition-all duration-500">
    <div class="w-full px-4 md:px-8 py-5 flex justify-between items-center">
        ...
        <nav class="hidden md:flex space-x-1 items-center text-sm font-semibold">
            <a href="/" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow flex items-center gap-2">
            ...
            <div class="relative group">
                <!-- Tombol utama -->
                <button class="flex items-center gap-2 text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow">
                    <i class="fas fa-user-circle"></i>
                    <span>Profil</span>
                    <i class="fas fa-chevron-down text-sm ml-1"></i>
                </button>
                <!-- Dropdown -->
                <div class="absolute left-0 mt-2 w-48 bg-white text-gray-800 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200">
                    <a href="{{ route('profile') }}" class="block px-4 py-2 hover:bg-gray-100 rounded-t-lg flex items-center gap-2">
                        <i class="fas fa-school text-primary"></i>
                        <span>Profil Sekolah</span>
                    </a>
                    <a href="{{ route('visimisi') }}" class="block px-4 py-2 hover:bg-gray-100 flex items-center gap-2">
                        <i class="fas fa-bullseye text-primary"></i>
                        <span>Visi & Misi</span>
                    </a>
                    <a href="{{ route('struktur') }}" class="block px-4 py-2 hover:bg-gray-100 rounded-b-lg flex items-center gap-2">
           ...
           <a href="{{ route('pengumuman.index') }}" 
            class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg flex items-center gap-2 hover-glow">
                <i class="fas fa-bullhorn"></i>
                <span>PENGUMUMAN</span>
            </a>

            
            <a href="/galeri" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow flex items-center gap-2">
                <i class="fas fa-images"></i>
                <span>GALERI</span>
            </a>
            
            <div class="relative group">
                <button class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow flex items-center gap-2">
                ...
                <div class="absolute left-0 mt-2 w-40 bg-white text-gray-800 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200">
                    <a href="{{ route('guru.guru') }}" class="block px-4 py-2 hover:bg-gray-100 rounded-t-lg flex items-center gap-2">
                        <i class="fas fa-user-tie text-primary"></i>
                        <span>Guru</span>
                    </a>
                    <a href="{{ route('guru.staff') }}" class="block px-4 py-2 hover:bg-gray-100 rounded-b-lg flex items-center gap-2">
            ...
            <div class="relative group">
                ...
                <div class="absolute left-0 mt-2 w-44 bg-white text-gray-800 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200">
                    <a href="/contact" class="block px-4 py-2 hover:bg-gray-100 rounded-t-lg flex items-center gap-2">
                        <i class="fas fa-phone text-primary"></i>
                        <span>Contact</span>
                    </a>
                    <a href="/buku-tamu" class="block px-4 py-2 hover:bg-gray-100 rounded-b-lg flex items-center gap-2">
    ...
    <div x-show="open"
        ...
        <a href="/" class="block hover:bg-white/20 px-4 py-3 rounded-xl font-semibold hover-lift flex items-center gap-3">
        ...
        <div x-data="{ dropProfil: false }" class="space-y-2">
            ...
            <div x-show="dropProfil" x-transition class="bg-white/10 rounded-xl overflow-hidden ml-4 shadow-inner">
                <a href="/profile" class="block px-5 py-3 hover:bg-white/20 text-sm border-b border-white/10 transition flex items-center gap-2">
                    <i class="fas fa-school"></i>
                    <span>Profil Sekolah</span>
                </a>
                <a href="/visi" class="block px-5 py-3 hover:bg-white/20 text-sm border-b border-white/10 transition flex items-center gap-2">
                    <i class="fas fa-eye"></i>
                    <span>Visi</span>
                </a>
                <a href="/misi" class="block px-5 py-3 hover:bg-white/20 text-sm transition flex items-center gap-2">
        ...
        <a href="{{ route('pengumuman.index') }}" 
        class="block hover:bg-white/20 px-4 py-3 rounded-xl font-semibold hover-lift flex items-center gap-3">
            <i class="fas fa-bullhorn w-5"></i>
            <span>PENGUMUMAN</span>
        </a>

        
        <a href="/galeri" class="block hover:bg-white/20 px-4 py-3 rounded-xl font-semibold hover-lift flex items-center gap-3">
            <i class="fas fa-images w-5"></i>
            <span>GALERI</span>
        </a>
        
        <a href="/guru" class="block hover:bg-white/20 px-4 py-3 rounded-xl font-semibold hover-lift flex items-center gap-3">
            <i class="fas fa-chalkboard-teacher w-5"></i>
            <span>GURU & STAFF</span>
        </a>
        
        <a href="/contact" class="block hover:bg-white/20 px-4 py-3 rounded-xl font-semibold hover-lift flex items-center gap-3">
        ...
        <form action="{{ route('search') }}" method="GET" class="pt-4 border-t border-blue-200">
            ...
            <button type="submit" class="mt-3 w-full bg-white text-primary py-3.5 rounded-full font-bold hover:bg-yellow-300 hover:text-primary-dark transition shadow-lg hover-lift flex items-center justify-center gap-2">
                <i class="fas fa-search"></i>
