...
<head>
    ...
    /* soft blue glow */
    background: radial-gradient(circle, rgba(147, 197, 253, 0.4), rgba(96, 165, 250, 0.2), rgba(59, 130, 246, 0.15));
    ...
    animation: ripple-premium 0.9s ease-out forwards;
}
