    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
            ...
            <div class="flex space-x-3">
                <a href="https://www.instagram.com/smpn38_palembang?igsh=aXl3aGlseG9xdDI5" class="bg-white/20 hover:bg-white hover:text-primary w-11 h-11 rounded-full flex items-center justify-center hover-lift transition-all">
