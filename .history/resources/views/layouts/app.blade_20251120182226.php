...
<header :class="scrolled ? 'navbar-scrolled' : 'bg-primary'" class="shadow-md sticky top-0 z-50 transition-all duration-500">
    <div class="w-full px-4 md:px-8 py-5 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4 group cursor-pointer">
            <div class="h-12 w-12 rounded-full bg-white p-2 shadow-xl hover-lift flex items-center justify-center">
                <i class="fas fa-graduation-cap text-2xl" style="color: #2925CC;"></i>
            </div>
            <div>
           ...
           <a href="#" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg hover-glow flex items-center">
            ...
            <div class="relative group">
                ...
                <div class="absolute left-0 mt-2 w-40 bg-white text-gray-800 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200">
                    <a href="#" class="block px-4 py-2 hover:bg-gray-100 rounded-t-lg">
                        Profil Sekolah
                    </a>
                    <a href="#" class="block px-4 py-2 hover:bg-gray-100">
                        Visi & Misi
                    </a>
                    <a href="#" class="block px-4 py-2 hover:bg-gray-100 rounded-b-lg">
                        Struktur Organisasi
                    </a>
                </div>
            </div>
            
           <a href="#" class="text-white hover:bg-white/20 px-4 py-2.5 rounded-lg flex items-center space-x-2 hover-glow">
            ...
            <form class="hidden md:flex items-center space-x-2">
                ...
                <button type="submit" class="bg-white px-5 py-2.5 rounded-full font-bold hover:bg-yellow-300 transition hover-lift shadow-lg" style="color: #2925CC;">
    ...
    <div x-show="open"
        ...
        <!-- Search Mobile -->
        <form class="pt-4 border-t border-blue-200">
            <div class="relative">
            ...
            <button type="submit" class="mt-3 w-full bg-white py-3.5 rounded-full font-bold hover:bg-yellow-300 transition shadow-lg hover-lift" style="color: #2925CC;">
...
<main class="py-20">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h2 class="text-4xl font-bold mb-4" style="color: #2925CC;">Selamat Datang di SMPN 38 Palembang</h2>
        <p class="text-gray-600 text-lg">Sekolah unggulan berbasis Kurikulum Merdeka yang menghasilkan generasi cerdas, berakhlak mulia, dan siap bersaing global.</p>
    </div>
</main>
    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
            ...
            <div class="flex space-x-3">
                <a href="#" target="_blank" rel="noopener" class="bg-white/20 hover:bg-white w-11 h-11 rounded-full flex items-center justify-center hover-lift transition-all" style="hover:color: #2925CC;">
                    <i class="fab fa-facebook-f text-lg"></i>
                </a>

                <a href="#" target="_blank" rel="noopener" class="bg-white/20 hover:bg-white w-11 h-11 rounded-full flex items-center justify-center hover-lift transition-all">
            ...
            <ul class="space-y-4 text-sm">
                <li class="flex items-start gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-all hover-lift">
                    <div class="bg-white rounded-full w-11 h-11 flex items-center justify-center flex-shrink-0 shadow-lg">
                        <i class="fas fa-phone-alt text-lg" style="color: #2925CC;"></i>
                    </div>
                    <div>
                ...
                <li class="flex items-start gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-all hover-lift">
                    <div class="bg-white rounded-full w-11 h-11 flex items-center justify-center flex-shrink-0 shadow-lg">
                        <i class="fas fa-envelope text-lg" style="color: #2925CC;"></i>
                    </div>
                    <div>
                ...
                <li class="flex items-start gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-all hover-lift">
                    <div class="bg-white rounded-full w-11 h-11 flex items-center justify-center flex-shrink-0 shadow-lg">
                        <i class="fas fa-map-marker-alt text-lg" style="color: #2925CC;"></i>
                    </div>
                    <div>
