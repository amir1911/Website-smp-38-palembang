    ...
    <header :class="scrolled ? 'navbar-scrolled' : 'bg-primary'"
        ...
        <div class="w-full px-4 md:px-8 py-5 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4 group cursor-pointer">
                <img src="{{ asset('storage/logo/Logo SMPN 38 PLG.jpg') }}" alt="Logo SMPN 38 Palembang"
            ...
            <nav class="hidden md:flex space-x-1 items-center text-sm font-semibold">
                ...
                <form action="{{ route('search') }}" method="GET" class="hidden md:flex items-center space-x-2">
                    ...
                    <button type="submit"
                        class="bg-white text-primary px-5 py-2.5 rounded-full font-bold hover:bg-yellow-300 hover:text-primary-dark transition hover-lift shadow-lg">
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-300"
            ...
            <!-- TENAGA PENDIDIK (DROPDOWN KLIK - FIX MOBILE) -->
            ...
            <!-- INFORMASI & KONTAK (DROPDOWN KLIK - FIX MOBILE) -->
            <div x-data="{ infoOpen: false }" class="space-y-2">
                ...
                <div x-show="infoOpen" x-transition class="bg-white/10 rounded-xl overflow-hidden ml-4 shadow-inner">
                    ...
                    <a href="/buku-tamu" class="block px-5 py-3 text-sm hover:bg-white/20">
                        Buku Tamu
                    </a>
                </div>
            </div>
            ...
            <form action="{{ route('search') }}" method="GET" class="pt-4 border-t border-blue-200">
                ...
                <button type="submit"
                    class="mt-3 w-full bg-white text-primary py-3.5 rounded-full font-bold shadow-lg hover:bg-yellow-300 hover:text-primary-dark transition hover-lift">
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
                ...
                <p class="text-sm text-white/95 leading-relaxed mb-6">
                    Sekolah unggulan berbasis Kurikulum Merdeka yang menghasilkan generasi cerdas, berakhlak mulia, dan
                    siap bersaing global.
                </p>

                <!-- Social Media -->
                <div class="flex space-x-3">
                    <a href="https://www.facebook.com/groups/262960747172852/?ref=share&mibextid=NSMWBT" target="_blank" rel="noopener"
                    ...
                    <a href="https://www.instagram.com/smpn38_palembang?igsh=aXl3aGlseG9xdDI5" target="_blank"
                        rel="noopener"
                        class="bg-white/20 hover:bg-white hover:text-primary w-11 h-11 rounded-full flex items-center justify-center hover-lift transition-all">
                        <i class="fab fa-instagram text-lg"></i>
                    </a>

                    <a href="https://www.tiktok.com/@spentipanplg?is_from_webapp=1&sender_device=pc" target="_blank"
                        rel="noopener"
                        class="bg-white/20 hover:bg-white hover:text-primary w-11 h-11 rounded-full flex items-center justify-center hover-lift transition-all">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href="/"
                            class="flex items-center hover:translate-x-2 transition-transform hover:text-yellow-300">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li
                        class="flex items-start gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-all hover-lift">
                        <div
                            class="bg-white rounded-full w-11 h-11 flex items-center justify-center flex-shrink-0 shadow-lg">
                            <i class="fas fa-phone-alt text-primary text-lg"></i>
                        </div>
                        <div>
                            <p class="font-semibold mb-1 text-white">Telepon</p>
                            <p class="text-white/95">0711813524</p>
                        </div>
                    </li>
                    <li
                        class="flex items-start gap-4 bg-white/10 rounded-xl p-4 hover:bg-white/20 transition-all hover-lift">
        ...
        <div class="border-t border-white/30 pt-8">
            <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-sm">
                ...
                <p class="text-center text-white/95">
                    Dibuat <i class="fas fa-heart text-red-400 mx-1"></i> oleh <b
                        class="text-white font-bold">Kelompok 3 RPL</b> | @2025
                </p>
            </div>
        </div>
    </footer>
...
document.addEventListener("DOMContentLoaded", () => {
    if (!localStorage.getItem("introShown")) {
        ...
        setTimeout(() => localStorage.setItem("introShown", "true"), 2800);
    }
});
</script>
...
document.addEventListener("pointerdown", function (e) {
    ...
    // Cegah error kalau pointer = stylus atau lain
