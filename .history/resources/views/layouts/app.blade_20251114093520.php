        ...
        <nav class="hidden md:flex space-x-1 items-center text-sm font-semibold">
            ...
            <div x-data="{ drop: false }" class="relative">
                ...
                <div x-show="drop" 
                    ...
                    <a href="{{ route('pengumuman.index') }}" class="block px-5 py-3 text-gray-700 hover:bg-blue-50 font-medium transition-all border-b border-gray-100">
                        <i class="fas fa-list mr-2 text-primary"></i>Semua Pengumuman
                    </a>
                    @foreach ($kategori_pengumuman as $kat)
                    <a href="{{ route('pengumuman.byKategori', $kat->id) }}" class="block px-5 py-3 text-gray-700 hover:bg-blue-50 transition-all">
    ...
    <div x-show="open"
        ...
        <div x-data="{ drop: false }" class="space-y-2">
            ...
            <div x-show="drop" x-transition class="bg-white/10 rounded-xl overflow-hidden ml-4 shadow-inner">
                <a href="{{ route('pengumuman.index') }}" class="block px-5 py-3 hover:bg-white/20 text-sm border-b border-white/10 transition">
                    <i class="fas fa-list mr-2"></i>Semua Pengumuman
                </a>
                @foreach ($kategori_pengumuman as $kat)
                <a href="{{ route('pengumuman.byKategori', $kat->id) }}" class="block px-5 py-3 hover:bg-white/20 text-sm transition">
