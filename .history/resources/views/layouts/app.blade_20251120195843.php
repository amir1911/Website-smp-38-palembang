...
<head>
    ...
    <style>
        ...
        .hover-glow:hover {
            box-shadow: 0 0 20px rgba(42, 80, 130, 0.4);
        }
        ...
        .touch-ripple {
            ...
            background: rgba(42, 80, 130, 0.45);
    ...
    <div class="w-full px-4 md:px-8 py-5 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4 group cursor-pointer">
            <div class="h-12 w-12 rounded-full bg-white p-2 shadow-xl hover-lift flex items-center justify-center">
                <i class="fas fa-school text-2xl" style="color: hsl(214, 51%, 34%);"></i>
            </div>
            <div>
...
<main class="min-h-screen py-20">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h1 class="text-5xl font-bold mb-6" style="color: #2A5082;">Selamat Datang di SMPN 38 Palembang</h1>
        <p class="text-xl text-gray-600 mb-8">Sekolah unggulan berbasis Kurikulum Merdeka</p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div class="bg-white p-8 rounded-2xl shadow-lg hover-lift">
                <div class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style="background-color: #2A5082;">
                    <i class="fas fa-book text-white text-2xl"></i>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: #2A5082;">Pendidikan Berkualitas</h3>
                <p class="text-gray-600">Kurikulum modern dan inovatif untuk masa depan cerah</p>
            </div>
            <div class="bg-white p-8 rounded-2xl shadow-lg hover-lift">
                <div class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style="background-color: #2A5082;">
                    <i class="fas fa-users text-white text-2xl"></i>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: #2A5082;">Guru Profesional</h3>
                <p class="text-gray-600">Tenaga pendidik berpengalaman dan berdedikasi tinggi</p>
            </div>
            <div class="bg-white p-8 rounded-2xl shadow-lg hover-lift">
                <div class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style="background-color: #2A5082;">
                    <i class="fas fa-trophy text-white text-2xl"></i>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: #2A5082;">Prestasi Gemilang</h3>
                <p class="text-gray-600">Berbagai penghargaan tingkat lokal hingga nasional</p>
            </div>
        </div>
    </div>
</main>
