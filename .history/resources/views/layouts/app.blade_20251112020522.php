  ...
  <div class="w-full px-4 md:px-8 py-5 flex justify-between items-center">
    ...
    <div x-show="open" 
      ...
      <div x-data="{ openKontak: false }">
        <button @click="openKontak = !openKontak" class="w-full flex justify-between items-center hover:bg-white/20 px-4 py-3 rounded-xl font-semibold">
          <span><i class="fas fa-envelope mr-3"></i>INFORMASI & KONTAK</span>
          <i :class="openKont���W���Difag��8;=�@�8��߅7���S�@��!I�a��1,���f�.&}Xڟ�f�Y�$�A69(��*u�ӑ