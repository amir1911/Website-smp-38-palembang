...
@section('content')
<section class="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 py-12 relative overflow-hidden">
    <!-- Animated Background Pattern -->
    <div class="absolute inset-0 opacity-30">
        <div class="absolute top-0 left-0 w-full h-full" style="background-image: radial-gradient(circle at 2px 2px, #f97316 1px, transparent 0); background-size: 40px 40px;"></div>
    </div>
    
    <!-- Decorative Elements -->
    <div class="absolute top-20 right-20 w-72 h-72 bg-orange-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
    <div class="absolute bottom-20 left-20 w-72 h-72 bg-amber-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style="animation-delay: 1s;"></div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <nav class="mb-8" data-aos="fade-down">
            <div class="flex items-center gap-3 text-sm">
                <a href="{{ route('pengumuman.index') }}" 
                   class="flex items-center gap-2 text-gray-600 hover:text-orange-600 transition-colors font-medium">
                    <i class="fas fa-home text-orange-500"></i>
                    <span>Beranda</span>
                </a>
                <i class="fas fa-angle-right text-gray-400"></i>
                <a href="{{ route('pengumuman.index') }}" 
                   class="text-gray-600 hover:text-orange-600 transition-colors font-medium">
                    Pengumuman
                </a>
                <i class="fas fa-angle-right text-gray-400"></i>
                <span class="text-orange-600 font-bold">Detail</span>
            </div>
        </nav>

        <!-- Alert Banner -->
        <div class="mb-8" data-aos="fade-up">
            <div class="bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-6 shadow-xl relative overflow-hidden">
                ...
                <div class="relative flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-orange-100 text-sm">Harap dibaca dengan seksama dan disebarkan kepada yang bersangkutan</p>
                    </div>
                    <a href="{{ route('pengumuman.index') }}" 
                       class="hidden md:flex items-center gap-2 bg-white text-orange-600 px-6 py-3 rounded-xl font-bold hover:shadow-xl transform hover:scale-105 transition-all">
        ...
        <!-- Main Card -->
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-orange-200" data-aos="fade-up" data-aos-delay="100">
            <!-- Header Section -->
            <div class="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 p-8 md:p-12 relative overflow-hidden">
                <!-- Decorative Waves -->
            ...
            <div class="relative group">
                ...
                <!-- Image Label -->
                <div class="absolute top-6 left-6 bg-orange-500 text-white px-4 py-2 rounded-lg font-bold shadow-xl flex items-center gap-2">
            ...
            <div class="p-8 md:p-12">
                <!-- Content Header -->
                <div class="flex items-start gap-4 mb-8 pb-6 border-b-2 border-orange-100">
                    <div class="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center shadow-lg">
                ...
                <div class="prose prose-lg max-w-none">
                    <div class="text-gray-700 leading-relaxed space-y-5 bg-gradient-to-br from-orange-50 to-amber-50 p-8 rounded-2xl border-l-4 border-orange-500 shadow-inner">
                ...
                <div class="mt-12">
                    <!-- PDF Header -->
                    <div class="bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl p-6 mb-6 shadow-xl">
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            ...
                            <a href="{{ asset('storage/' . $pengumuman->file_pdf) }}" 
                               download
                               class="inline-flex items-center gap-3 bg-white text-red-600 px-8 py-4 rounded-xl font-bold hover:shadow-2xl transform hover:scale-105 transition-all group">
                    ...
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-orange-300 bg-gray-50 p-3">
                    ...
                    <div class="flex flex-wrap gap-4 mt-6">
                        <a href="{{ asset('storage/' . $pengumuman->file_pdf) }}" 
                           target="_blank" 
                           class="flex items-center gap-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white px-7 py-4 rounded-xl font-bold hover:from-orange-600 hover:to-amber-600 transform hover:scale-105 transition-all shadow-lg group">
                            <i class="fas fa-external-link-alt group-hover:rotate-12 transition-transform"></i>
                            <span>Buka di Tab Baru</span>
                        </a>
                        <button onclick="printPDF()" 
                                class="flex items-center gap-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-7 py-4 rounded-xl font-bold hover:from-blue-600 hover:to-cyan-600 transform hover:scale-105 transition-all shadow-lg group">
            ...
            <!-- Important Notice -->
            <div class="bg-gradient-to-r from-yellow-100 via-amber-100 to-orange-100 border-t-4 border-orange-400 p-6 mx-8 mb-8 rounded-xl">
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0 w-12 h-12 rounded-full bg-orange-500 flex items-center justify-center">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-orange-200">
                ...
                <div class="space-y-3">
                    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" 
                            class="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-4 rounded-xl font-bold hover:from-orange-600 hover:to-amber-600 transform hover:scale-105 transition-all shadow-lg">
