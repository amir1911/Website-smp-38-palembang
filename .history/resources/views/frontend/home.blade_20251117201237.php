...
<section class="bg-gradient-to-br from-[#49ADFF] via-[#3B9EE8] to-[#2D8FD7] text-white py-12 sm:py-16 md:py-20 lg:py-24 font-poppins relative overflow-hidden">
  
  <!-- Decorative Circles -->
  <div class="absolute top-10 left-10 w-32 h-32 border-4 border-white/20 rounded-full"></div>
  <div class="absolute bottom-20 right-20 w-48 h-48 border-4 border-white/10 rounded-full"></div>
  <div class="absolute top-1/2 left-1/4 w-24 h-24 bg-white/5 rounded-full blur-2xl"></div>
  <div class="absolute bottom-1/3 right-1/3 w-64 h-64 bg-cyan-300/10 rounded-full blur-3xl"></div>
  
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-16 items-center px-4 sm:px-6 md:px-8 relative z-10">

    <!-- Foto Kepala Sekolah -->
    <div class="flex flex-col items-center" data-aos="fade-right" data-aos-duration="800">
      <div class="relative animate-float">
        <!-- Decorative Elements Behind Photo -->
        <div class="absolute -top-4 -left-4 w-20 h-20 bg-cyan-400/30 rounded-full blur-xl"></div>
        <div class="absolute -bottom-4 -right-4 w-24 h-24 bg-blue-400/30 rounded-full blur-xl"></div>
        
        <!-- Photo Card -->
        <div class="bg-white/15 backdrop-blur-lg border-4 border-cyan-300/50 rounded-3xl p-4 shadow-2xl relative">
          <div class="relative rounded-2xl overflow-hidden w-[240px] sm:w-[280px] md:w-[320px] lg:w-[380px] xl:w-[420px] image-shine shadow-xl">
            <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop" 
                 alt="Kepala Sekolah" 
                 class="w-full h-[240px] sm:h-[280px] md:h-[340px] lg:h-[400px] object-cover transform hover:scale-110 transition-transform duration-700">
          </div>
        </div>
      </div>
      
      <!-- Name and Title -->
      <div class="mt-6 text-center bg-white/10 backdrop-blur-md rounded-2xl px-8 py-4 shadow-lg border border-white/20">
        <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold drop-shadow-lg">Windah</h2>
        <p class="text-sm sm:text-base text-cyan-100 mt-1 font-medium">Kepala Sekolah</p>
      </div>
    </div>

    <!-- Teks Sambutan -->
    <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
      <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl border border-white/20">
        
        <!-- Quote Icon -->
        <div class="text-6xl text-white/20 font-serif leading-none mb-4">"</div>
        
        <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">
          Sambutan Kepala Sekolah
        </h3>
        
        <div class="w-20 h-1 bg-gradient-to-r from-cyan-300 to-transparent mb-6"></div>
        
        <p class="italic mb-6 text-base sm:text-lg md:text-xl text-cyan-50 font-light">
          Assalamu'alaikum warahmatullahi wabarakatuh
        </p>
        
        <div class="space-y-4 text-justify text-sm sm:text-base md:text-lg leading-relaxed text-white/95">
          <p>
          ...
          <p class="italic text-cyan-100 font-medium">
        ...
        <div class="mt-8 pt-6 border-t border-white/20">
          <p class="text-right text-cyan-100 font-semibold">Windah</p>
          <p class="text-right text-sm text-cyan-200">Kepala SMP Negeri 38 Palembang</p>
        </div>
      </div>
    </div>
