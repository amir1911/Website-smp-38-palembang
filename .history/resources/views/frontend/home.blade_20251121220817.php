...
<div class="absolute inset-0 flex flex-col items-center justify-center px-6 sm:px-8 md:px-12 lg:px-16 text-center">
    ...
    <!-- Tombol optional -->
    <a href="#"
        class="mt-6 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-full text-sm sm:text-base shadow-lg transition-all">
        Selengkapnya
    </a>
</div>
...
<section class="bg-[#1D4E89] text-white py-16 sm:py-20 md:py-24 font-poppins relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center px-6 sm:px-8 relative z-10">
        ...
        <!-- Photo Section -->
        <div class="flex flex-col items-center lg:items-start" data-aos="fade-right">
            <div class="mb-8 text-center lg:text-left">
                <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg">
                    Sambutan<br/>
                    <span class="text-white-300">Kepala Sekolah</span>
                </h3>
            </div>
...
<section id="statistik-section" class="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-[#DBEDFF] to-white">
    <div class="container mx-auto text-center px-6">
        ...
        <div class="flex flex-wrap justify-center gap-10">
            <!-- Guru -->
            <div class="bg-[#1D4E89] rounded-full p-8 flex flex-col items-center justify-center shadow-xl w-48 h-48 sm:w-52 sm:h-52 hover:scale-110 hover:shadow-2xl transition duration-300"
                 data-aos="zoom-in"
                 data-aos-delay="100">
                <div class="bg-white rounded-full p-3 mb-3 shadow-md">
                    <img src="https://img.icons8.com/ios-filled/100/1D4E89/teacher.png" class="w-14 h-14">
                </div>
                <span class="text-5xl font-extrabold text-white counter" data-target="{{ $statistik->guru ?? 0 }}">0</span>
                <span class="text-xl text-white mt-2">Guru</span>
            </div>
            ...
            <div class="bg-[#1D4E89] rounded-full p-8 flex flex-col items-center justify-center shadow-xl w-48 h-48 sm:w-52 sm:h-52 hover:scale-110 hover:shadow-2xl transition duration-300"
                 ...
                 data-aos-delay="200">
                <div class="bg-white rounded-full p-3 mb-3 shadow-md">
                    <img src="https://img.icons8.com/ios-filled/100/1D4E89/student-male.png" class="w-14 h-14">
                </div>
                <span class="text-5xl font-extrabold text-white counter" 
                      data-target="{{ ($statistik->kelas7 ?? 0) + ($statistik->kelas8 ?? 0) + ($statistik->kelas9 ?? 0) }}">0</span>
                <span class="text-xl text-white mt-2">Siswa</span>
            </div>
            ...
            <div class="bg-[#1D4E89] rounded-full p-8 flex flex-col items-center justify-center shadow-xl w-48 h-48 sm:w-52 sm:h-52 hover:scale-110 hover:shadow-2xl transition duration-300"
                 ...
                 data-aos-delay="300">
                <div class="bg-white rounded-full p-3 mb-3 shadow-md">
                    <img src="https://img.icons8.com/ios-filled/100/1D4E89/conference.png" class="w-14 h-14">
                </div>
                <span class="text-5xl font-extrabold text-white counter" data-target="{{ $statistik->staf ?? 0 }}">0</span>
                <span class="text-xl text-white mt-2">Staf</span>
            </div>
        </div>
    </div>
</section>
