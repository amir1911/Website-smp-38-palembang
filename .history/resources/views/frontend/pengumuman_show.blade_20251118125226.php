...
@section('content')
<section class="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-sky-100 py-12 relative overflow-hidden">
    <!-- Animated Floating Shapes -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-20 left-10 w-20 h-20 bg-cyan-300 rounded-full opacity-30 animate-float"></div>
        <div class="absolute top-40 right-20 w-16 h-16 bg-blue-300 rounded-full opacity-30 animate-float-delay-1"></div>
        <div class="absolute bottom-40 left-1/4 w-24 h-24 bg-sky-300 rounded-full opacity-30 animate-float-delay-2"></div>
        <div class="absolute bottom-20 right-1/3 w-20 h-20 bg-teal-300 rounded-full opacity-30 animate-float-delay-3"></div>
        <div class="absolute top-1/2 left-1/2 w-32 h-32 bg-indigo-300 rounded-full opacity-20 animate-pulse-slow"></div>
    </div>

    <!-- Animated Gradient Background -->
    <div class="absolute inset-0 opacity-30">
        <div class="absolute top-0 left-0 w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
        ...
        <div class="absolute bottom-0 left-1/2 w-96 h-96 bg-sky-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
    </div>

    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <!-- Animated Breadcrumb -->
        <nav class="mb-8 animate-slide-down">
            <div class="flex items-center gap-3 text-sm bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg w-fit border border-blue-200">
                <a href="{{ route('pengumuman.index') }}" 
                   class="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-all duration-300 transform hover:scale-110">
                    <i class="fas fa-home text-blue-500 animate-bounce-slow"></i>
                    <span class="font-medium">Beranda</span>
                </a>
                <i class="fas fa-chevron-right text-gray-400 animate-pulse"></i>
                <a href="{{ route('pengumuman.index') }}" 
                   class="text-gray-600 hover:text-blue-600 transition-all duration-300 font-medium transform hover:scale-110">
                    Pengumuman
                </a>
                <i class="fas fa-chevron-right text-gray-400 animate-pulse"></i>
                <span class="text-blue-600 font-bold">Detail</span>
            </div>
        </nav>

        <!-- Animated Alert Banner -->
        <div class="mb-8 animate-slide-up">
            <div class="relative bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 rounded-3xl p-6 shadow-2xl overflow-hidden group">
                ...
                <div class="relative flex items-center gap-4">
                    ...
                    <a href="{{ route('pengumuman.index') }}" 
                       class="hidden md:flex items-center gap-2 bg-white text-blue-600 px-6 py-3 rounded-xl font-bold hover:shadow-2xl transform hover:scale-110 transition-all duration-300 animate-pulse-slow">
        ...
        <!-- Main Animated Card -->
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-blue-200 animate-scale-in">
            <!-- Animated Header Section -->
            <div class="relative bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 p-8 md:p-12 overflow-hidden group">
            ...
            <div class="relative group overflow-hidden animate-fade-in">
                ...
                <div class="absolute top-6 left-6 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 rounded-xl font-bold shadow-2xl flex items-center gap-2 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500">
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="flex items-start gap-4 mb-8 pb-6 border-b-2 border-blue-100 animate-fade-in-up">
                    <div class="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg animate-bounce-slow">
                ...
                <div class="prose prose-lg max-w-none animate-fade-in">
                    <div class="text-gray-700 leading-relaxed space-y-5 bg-gradient-to-br from-cyan-50 to-blue-50 p-8 rounded-2xl border-l-4 border-blue-500 shadow-inner hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="mt-12 animate-fade-in-up">
                    <!-- Animated PDF Header -->
                    <div class="relative bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-6 mb-6 shadow-xl overflow-hidden group">
                        ...
                        <div class="relative flex items-center justify-between flex-wrap gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-cyan-100 text-sm">Lihat atau unduh dokumen lengkap di bawah ini</p>
                                </div>
                            </div>
                            <a href="{{ asset('storage/' . $pengumuman->file_pdf) }}" 
                               download
                               class="inline-flex items-center gap-3 bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:shadow-2xl transform hover:scale-110 transition-all duration-300 group">
                    ...
                    <!-- Animated PDF Viewer -->
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-blue-300 bg-gray-50 p-3 animate-scale-in">
                        <div class="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 animate-gradient"></div>
                        <iframe 
                    ...
                    <div class="flex flex-wrap gap-4 mt-6">
                        <a href="{{ asset('storage/' . $pengumuman->file_pdf) }}" 
                           target="_blank" 
                           class="flex items-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-7 py-4 rounded-xl font-bold hover:from-cyan-600 hover:to-blue-700 transform hover:scale-110 hover:rotate-1 transition-all duration-300 shadow-lg animate-slide-in-left">
                            <i class="fas fa-external-link-alt"></i>
                            <span>Buka di Tab Baru</span>
                        </a>
                        <button onclick="printPDF()" 
                                class="flex items-center gap-3 bg-gradient-to-r from-indigo-500 to-sky-600 text-white px-7 py-4 rounded-xl font-bold hover:from-indigo-600 hover:to-sky-700 transform hover:scale-110 hover:-rotate-1 transition-all duration-300 shadow-lg animate-slide-in-right">
            ...
            <div class="bg-gradient-to-r from-sky-100 via-cyan-100 to-blue-100 border-t-4 border-blue-500 p-6 mx-8 mb-8 rounded-xl animate-fade-in-up transform hover:scale-105 transition-all duration-300">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h5 class="font-bold text-blue-900 mb-2 text-lg">Catatan Penting</h5>
        ...
        <div class="mt-10 grid md:grid-cols-2 gap-6">
            <!-- Animated Share Card -->
            <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-blue-200 animate-slide-in-left transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center animate-spin-slow">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <button onclick="shareToFacebook()" 
                            class="flex items-center justify-center gap-2 bg-blue-600 text-white px-5 py-4 rounded-xl font-bold hover:bg-blue-700 transform hover:scale-110 hover:-rotate-3 transition-all duration-300 shadow-md animate-fade-in-delay">
                        <i class="fab fa-facebook-f text-xl animate-bounce-slow"></i>
                        <span class="text-sm">Facebook</span>
                    </button>
                    <button onclick="copyLink()" 
                            class="col-span-2 flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-5 py-4 rounded-xl font-bold hover:from-cyan-700 hover:to-blue-700 transform hover:scale-110 transition-all duration-300 shadow-md animate-fade-in-delay-2">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-blue-200 animate-slide-in-right transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center animate-pulse">
                ...
                <div class="space-y-3">
                    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" 
                            class="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-4 rounded-xl font-bold hover:from-cyan-600 hover:to-blue-700 transform hover:scale-110 transition-all duration-300 shadow-lg">
...
<div id="toast" class="fixed bottom-8 right-8 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-5 rounded-2xl shadow-2xl transform translate-y-32 transition-all duration-500 flex items-center gap-4 z-50 border-2 border-white/30">
...
.animate-particle-1 {
    animation: particle1 5s ease-in-out infinite;
}
