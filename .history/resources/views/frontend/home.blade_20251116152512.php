...
<section class="relative w-full overflow-hidden font-[Poppins] bg-white" 
    ...
    <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
        <div 
            ...
            <!-- Grid Layout -->
            <div class="absolute inset-0 grid grid-cols-12 gap-4 sm:gap-6 md:gap-8 p-8 sm:p-12 md:p-16 lg:p-20">
                <!-- Left: Title Area -->
                <div class="col-span-12 md:col-span-5 lg:col-span-4 flex flex-col justify-end pb-8 md:pb-0">
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <!-- Title -->
                        <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extralight text-slate-800 leading-[1.1] tracking-tight" 
                            x-text="item.judul">
                        </h3>
                        ...
                        <!-- Slide info -->
                        <div class="flex items-baseline gap-3 text-slate-500">
                            <span class="text-3xl sm:text-4xl font-extralight" x-text="String(current).padStart(2, '0')"></span>
                            <span class="text-sm">/ <span x-text="String(total).padStart(2, '0')"></span></span>
                        </div>
                    </div>
                </div>
                
                <!-- Right: Image Area -->
                <div class="col-span-12 md:col-span-7 lg:col-span-8 relative">
                    <!-- Thin border frame -->
                    <div class="absolute inset-0 border border-slate-200"></div>
                    <div class="absolute inset-2 overflow-hidden">
                        ...
                        <!-- Minimal blue tint -->
                        <div class="absolute inset-0 bg-gradient-to-br from-sky-500/30 via-blue-400/20 to-cyan-500/30"></div>
                    </div>
    ...
    <div class="absolute bottom-8 sm:bottom-12 md:bottom-16 lg:bottom-20 left-8 sm:left-12 md:left-16 lg:left-20 flex items-center gap-6">
        <button @click="current = current === 1 ? total : current - 1" 
                class="w-10 h-10 border border-slate-300 hover:border-sky-400 hover:bg-sky-50 text-slate-600 hover:text-sky-600 transition-all duration-300 flex items-center justify-center">
        ...
        <div class="flex gap-2">
            <template x-for="i in total">
                <button 
                    ...
                    :class="current === i ? 'w-16 bg-sky-400' : 'w-8 bg-slate-300 hover:bg-sky-300'">
                </button>
            </template>
        </div>
