...
@section('content')
    ...
    <!-- ========================================
             ...
             ======================================== -->
 <section class="bg-gradient-to-br from-[#1D4E89] to-[#2563EB] text-white py-16 sm:py-20 md:py-24 font-poppins relative overflow-hidden">
    <!-- Animated Background Pattern -->
    <div class="absolute inset-0 opacity-10">
        <img src="{{ asset('images/bg-wave.jpg') }}" alt="Background"
    ...
    <div class="absolute bottom-32 left-1/4 w-20 h-20 border-4 border-white/10 rounded-lg rotate-12"></div>
    <div class="absolute bottom-20 right-1/3 w-8 h-8 bg-white/10 rounded-full"></div>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center px-6 sm:px-8 relative z-10">
        ...
        <div class="flex flex-col items-center lg:items-start">
            ...
            <div class="mb-10 text-center lg:text-left">
                <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg leading-tight">
                    Sambutan
                    <span class="block text-blue-300 mt-2">Kepala Sekolah</span>
                </h2>
            </div>
            ...
            <div class="relative group">
                <!-- Outer Glow Effect -->
                <div class="absolute -inset-4 bg-gradient-to-br from-blue-400/30 to-blue-600/30 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                
                <!-- Rotating Background -->
                <div class="absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-600 rounded-3xl rotate-3 group-hover:rotate-6 transition-all duration-500"></div>

                <!-- Main Photo Container -->
                <div class="relative bg-white p-3 rounded-3xl shadow-2xl group-hover:-translate-y-2 group-hover:shadow-3xl transition-all duration-500">
                    <div class="relative rounded-2xl overflow-hidden w-[280px] sm:w-[320px] md:w-[360px]">
                        <img src="{{ asset('storage/guru/kepalasekolah.jpeg') }}" 
                            alt="Kepala Sekolah"
                            class="w-full h-[320px] sm:h-[360px] md:h-[400px] object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <!-- Name Badge -->
                    <div class="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-gradient-to-r from-white to-blue-50 text-[#1D4E89] px-8 py-4 rounded-full shadow-2xl min-w-[280px] sm:min-w-[300px] border-4 border-white">
                        <h3 class="text-lg sm:text-xl font-bold text-center leading-tight">
            ...
            <!-- Role Badge -->
            <div class="mt-12 flex items-center justify-center gap-3 bg-white/20 backdrop-blur-sm px-8 py-3 rounded-full border border-white/30 shadow-lg hover:bg-white/30 transition-all duration-300">
                <div class="w-2.5 h-2.5 bg-green-400 rounded-full animate-pulse shadow-lg shadow-green-400/50"></div>
                <p class="text-sm sm:text-base font-semibold">Kepala Sekolah SMP Negeri 38 Palembang</p>
            </div>
        </div>

        <!-- Message Content -->
        <div>
            <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 sm:p-10 shadow-2xl border border-white/30 hover:bg-white/15 transition-all duration-300">
                <!-- Greeting -->
                <div class="mb-6 pb-6 border-b border-white/20">
                    <p class="text-blue-200 font-medium text-lg italic">
                ...
                <div class="space-y-6 text-sm sm:text-base leading-relaxed">
                    <p class="text-justify text-white/95">
                        Puji syukur kita panjatkan ke hadirat Allah SWT. 
                        <span class="font-semibold text-blue-200">SMP Negeri 38 Palembang</span> 
                        dapat terus berkomitmen memberikan pendidikan terbaik bagi generasi penerus bangsa.
                    </p>

                    <p class="text-justify text-white/95">
                        Kami berupaya menciptakan lingkungan belajar yang inovatif, inklusif, dan berprestasi. 
                        Dengan dukungan tenaga pendidik profesional dan fasilitas memadai, kami yakin dapat 
                        mencetak generasi yang unggul dalam akademik maupun karakter.
                    </p>

                    <p class="text-justify text-white/95">
                        Mari bersama-sama mewujudkan visi dan misi sekolah untuk menciptakan siswa yang cerdas, 
                ...
                <div class="mt-8 pt-6 border-t border-white/20">
                    <p class="text-blue-200 font-medium italic mb-6">
                        Wassalamu'alaikum warahmatullahi wabarakatuh
                    </p>

                    <div class="flex items-center gap-4">
                        <div class="w-20 h-1 bg-gradient-to-r from-blue-300 to-transparent rounded-full"></div>
                        <div>
                            <p class="font-bold text-xl text-white">Windah</p>
                            <p class="text-sm text-blue-200 mt-1">Kepala SMP Negeri 38 Palembang</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div x-ref="carousel"
            ...
            @foreach ($ekstrakurikulers as $index => $item)
                <div class="flex-shrink-0 w-80 bg-white rounded-3xl shadow-xl p-5 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl snap-center"
                    ...
                    <!-- NAMA KEGIATAN -->
                    <div
                        class="bg-[#1D4E89] text-white font-semibold text-lg rounded-full py-3 mb-4 text-center capitalize">
                        {{ $item->nama_kegiatan }}
                    </div>
                    ...
                    <div x-data="{ open: false }" class="text-center">
                        ...
                        <!-- Deskripsi Pendek -->
                        <p x-show="!open" class="text-gray-700 leading-relaxed text-sm mt-2 min-h-[55px]">
                            {{ Str::limit($item->deskripsi, 90) }}
                        </p>

                        <!-- Deskripsi Lengkap -->
                        <p x-show="open" x-transition class="text-gray-700 leading-relaxed text-sm mt-2">
                            {{ $item->deskripsi }}
                        </p>

                        <!-- Tombol -->
                        <button @click="open = !open" class="mt-3 text-blue-600 font-semibold text-sm hover:underline">
