        ...
        <div class="flex flex-col items-center">
            ...
            <div class="relative group mb-6">
                ...
                <div class="relative bg-white p-3 rounded-3xl shadow-2xl group-hover:-translate-y-2 transition-all duration-500">
                    ...
                    <!-- Photo Container -->
                    <div class="relative rounded-2xl overflow-hidden w-full aspect-[3/4]">
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-3xl p-8 sm:p-10 shadow-2xl border border-white/20">
                ...
                <div class="space-y-5 text-sm sm:text-base leading-relaxed">
                    ...
                    <p class="text-justify text-white/90">
                        ...
                        serta masyarakat yang ingin mengenal lebih dekat sekolah kami.
                    </p>

                    <p class="text-justify text-white/90">
                        Sebagai lembaga pendidikan, kami berkomitmen untuk menciptakan lingkungan belajar yang 
                        nyaman, berkarakter, dan berprestasi. Melalui kerja sama antara guru, orang tua, dan 
                        peserta didik, kami terus berupaya mengembangkan potensi siswa agar siap menghadapi 
