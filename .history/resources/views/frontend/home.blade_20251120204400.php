...
<section class="relative w-full overflow-hidden font-[Poppins] 
                bg-gradient-to-b from-white via-[var(--blue-light)]/20 to-white"
     x-data="{ 
         current: 1, 
    ...
    <!-- Slide Items -->
    <div class="relative w-full h-[350px] sm:h-[450px] md:h-[550px] 
                lg:h-[600px] xl:h-[650px] overflow-hidden">
            ...
            <div x-show="current === index + 1"
                ...
                <div class="relative w-full h-full">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t 
                                ...
                                via-[var(--blue-main)]/50 
                                to-transparent"></div>
                </div>

                <!-- TEXT -->
                <div class="absolute left-0 right-0 px-6 sm:px-8 md:px-12 lg:px-16 bottom-28">
                    <div class="w-full max-w-7xl mx-auto">
                        <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 
                                   font-bold text-white mb-4">
                            <span x-text="item.judul"></span>
                        </h2>

                        <p class="text-sm sm:text-base md:text-lg text-[var(--blue-light)] max-w-2xl leading-relaxed"
    ...
    <div class="absolute inset-0 flex justify-between items-center px-4 sm:px-6 md:px-8 pointer-events-none">
        ...
        <button @click="current = current === 1 ? total : current - 1; progress = 0;"
                class="pointer-events-auto group bg-white 
                       hover:bg-[var(--blue-main)] text-[var(--blue-main)] hover:text-white
                       rounded-full p-3 sm:p-4 shadow-lg transition-all duration-300 hover:scale-110">
    ...
    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t 
                from-white/90 to-transparent backdrop-blur-sm py-5">
        <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <template x-for="i in total">
                    ...
                    <button @click="current = i; progress = 0;" 
                            ...
                            :class="current === i ? 'w-16' : 'w-10'">

                        <div class="h-1.5 bg-[var(--blue-light)] rounded-full overflow-hidden">
                            <div x-show="current === i"
                                 class="h-full bg-gradient-to-r from-[var(--blue-main)] to-[var(--blue-dark)] rounded-full"
                                 :style="`width: ${current === i ? progress : 0}%`"></div>
                        </div>

                        <div x-show="current === i" 
                             class="absolute -top-8 left-1/2 -translate-x-1/2 
                                    bg-[var(--blue-main)] text-white text-xs px-2 py-1 rounded">
            ...
            <div class="flex items-center space-x-4 text-[var(--blue-dark)] font-semibold text-base">
                <span x-text="current"></span>
                <span class="text-[var(--blue-light)]">/</span>
                <span x-text="total"></span>

                <button @click="autoplay = !autoplay; progress = 0;"
                        class="bg-[var(--blue-light)] hover:bg-[var(--blue-main)] 
                               text-[var(--blue-dark)] hover:text-white 
                               p-2 rounded-lg transition">
                    <svg x-show="autoplay" class="w-5 h-5" fill="currentColor">
