...
<section 
  ...
  <!-- Judul -->
  <h2 
    class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white text-center mb-12"
    style="text-shadow: 0 3px 6px rgba(0,0,0,0.3);"
    data-aos="fade-up"
  >
...
<!-- Section Keunggulan Sekolah -->
<section class="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-[#DBEDFF] to-[#C7DBF3] overflow-hidden">

  <div class="max-w-7xl mx-auto px-6 text-center">

    <!-- JUDUL -->
    <h2 
      class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-12"
      style="text-shadow: 0 3px 6px rgba(0,0,0,0.3);"
      data-aos="fade-down"
    >
      Keunggulan Sekolah
