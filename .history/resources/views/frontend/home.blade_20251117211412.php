...
<section class="relative w-full overflow-hidden font-[Poppins] bg-gradient-to-b from-white via-blue-50/30 to-white"
    ...
    <!-- Slide Items Wrapper -->
    <div class="relative w-full h-[650px] sm:h-[450px] md:h-[550px] lg:h-[600px] xl:h-[650px] overflow-hidden">
...
<section class="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 sm:py-20 md:py-24 lg:py-32 font-[Poppins] overflow-hidden">
 ...
 <div class="flex items-center gap-3 justify-center lg:justify-start">
  ...
  <div class="h-1 w-12 bg-gradient-to-r from-blue-300 to-cyan-300 rounded-full"></div>
      ...
      <!-- Fitur Unggulan -->
      {{-- <div class="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0 pt-4">
        ...
        <div class="text-center border-x border-gray-200">
          ...
          <div class="text-xs text-gray-500">Tenaga Pendidik</div>
        </div>
        <div class="text-center">
