...
//kata sambutan kepala sekolah (css nya di home.css)
...
<section class="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-16 sm:py-20 md:py-24 lg:py-32 font-[Poppins] overflow-hidden">
  ...
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div class="absolute top-40 right-20 w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
    <div class="absolute bottom-32 left-1/4 w-2 h-2 bg-cyan-300 rounded-full animate-ping" style="animation-delay: 1s;"></div>
    <div class="absolute bottom-20 right-1/3 w-3 h-3 bg-blue-300 rounded-full animate-pulse" style="animation-delay: 0.5s;"></div>
  </div>

  <div class="relative max-w-7xl mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center px-4 sm:px-6 md:px-8">

    <!-- Kiri: Teks Profil -->
    <div data-aos="fade-right" data-aos-duration="1000" class="text-center lg:text-left space-y-6">
      
      <!-- Animated Line Accent -->
      <div class="flex items-center gap-4 justify-center lg:justify-start mb-6">
        <div class="h-px w-12 bg-gradient-to-r from-transparent via-cyan-400 to-cyan-400"></div>
        <span class="text-cyan-400 text-sm font-bold tracking-[0.3em] uppercase">Sekolah Unggulan</span>
        <div class="h-px w-12 bg-gradient-to-r from-cyan-400 via-cyan-400 to-transparent"></div>
      </div>

      <!-- Judul dengan Efek Neon -->
      <div class="space-y-2">
        <h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-1 tracking-tight relative inline-block">
          SMP NEGERI 
          <span class="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-300 drop-shadow-[0_0_30px_rgba(34,211,238,0.5)]">
            38 PALEMBANG
          </span>
        </h2>
      </div>

      <!-- Deskripsi dengan Card Glass -->
      <div class="relative group">
        <div class="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
        <div class="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-8">
          <p class="text-gray-200 text-base sm:text-lg md:text-xl leading-relaxed">
            Sekolah unggulan berbasis 
            <span class="font-bold text-cyan-400">Kurikulum Merdeka</span> 
            yang berkomitmen membentuk generasi 
            <span class="text-white font-semibold">berkarakter</span>, 
            <span class="text-white font-semibold">mandiri</span>, dan 
            <span class="text-white font-semibold">kreatif</span> 
      ...
      <!-- Stats Cards -->
      <div class="grid grid-cols-3 gap-3 md:gap-4 pt-4">
        <div class="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-sm border border-cyan-400/30 rounded-xl p-4 hover:scale-105 transition-transform duration-300">
          <div class="text-3xl font-black text-cyan-400">500+</div>
          <div class="text-xs text-gray-300 mt-1">Siswa</div>
        </div>
        <div class="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-sm border border-blue-400/30 rounded-xl p-4 hover:scale-105 transition-transform duration-300">
          <div class="text-3xl font-black text-blue-400">50+</div>
          <div class="text-xs text-gray-300 mt-1">Guru</div>
        </div>
        <div class="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-sm border border-cyan-400/30 rounded-xl p-4 hover:scale-105 transition-transform duration-300">
          <div class="text-3xl font-black text-cyan-400">A</div>
          <div class="text-xs text-gray-300 mt-1">Akreditasi</div>
        </div>
      </div>
      ...
      <div class="pt-4 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
        <a href="/profile"
           class="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-full font-bold text-base md:text-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(34,211,238,0.6)]">
          <span class="relative z-10">Explore More</span>
          <svg class="relative z-10 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="#kontak"
           class="group inline-flex items-center justify-center gap-3 bg-transparent border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-full font-bold text-base md:text-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300">
    ...
    <!-- Kanan: Logo Sekolah dengan Efek Futuristik -->
    <div class="flex justify-center mb-10 lg:mb-0" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
      <div class="relative group">
        
        <!-- Rotating Ring Outer -->
        <div class="absolute inset-0 rounded-full border-2 border-cyan-400/30 animate-spin-slow"></div>
        <div class="absolute inset-4 rounded-full border-2 border-blue-400/20 animate-spin-reverse"></div>
        
        <!-- Glow Effect -->
        <div class="absolute inset-0 bg-gradient-to-br from-cyan-400/40 to-blue-400/40 rounded-full blur-3xl group-hover:blur-[100px] transition-all duration-700"></div>
        
        <!-- Main Card -->
        <div class="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-full p-8 sm:p-10 md:p-12 border-2 border-cyan-400/50 shadow-[0_0_50px_rgba(34,211,238,0.3)] group-hover:shadow-[0_0_80px_rgba(34,211,238,0.5)] transition-all duration-500">
          
          <!-- Inner Glow -->
          <div class="absolute inset-8 rounded-full bg-gradient-to-br from-cyan-400/10 to-blue-400/10"></div>
          
          <!-- Logo Container -->
          <div class="relative z-10 bg-white rounded-full p-6 shadow-2xl">
            <img src="{{ asset('storage/logo/smp38palembang.jpg') }}" 
                 alt="Logo SMP Negeri 38 Palembang"
                 class="w-[200px] sm:w-[240px] md:w-[300px] lg:w-[360px] h-auto object-contain mx-auto animate-float">
          </div>
          
          <!-- Corner Accents -->
          <div class="absolute top-4 left-4 w-8 h-8">
            <div class="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-cyan-400 to-transparent"></div>
            <div class="absolute top-0 left-0 w-0.5 h-full bg-gradient-to-b from-cyan-400 to-transparent"></div>
          </div>
          <div class="absolute top-4 right-4 w-8 h-8">
            <div class="absolute top-0 right-0 w-full h-0.5 bg-gradient-to-l from-cyan-400 to-transparent"></div>
            <div class="absolute top-0 right-0 w-0.5 h-full bg-gradient-to-b from-cyan-400 to-transparent"></div>
          </div>
          <div class="absolute bottom-4 left-4 w-8 h-8">
            <div class="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-cyan-400 to-transparent"></div>
            <div class="absolute bottom-0 left-0 w-0.5 h-full bg-gradient-to-t from-cyan-400 to-transparent"></div>
          </div>
          <div class="absolute bottom-4 right-4 w-8 h-8">
            <div class="absolute bottom-0 right-0 w-full h-0.5 bg-gradient-to-l from-cyan-400 to-transparent"></div>
            <div class="absolute bottom-0 right-0 w-0.5 h-full bg-gradient-to-t from-cyan-400 to-transparent"></div>
          </div>
        </div>
        
        <!-- Floating Label -->
        <div class="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg whitespace-nowrap">
          Est. 1995
        </div>
      </div>
    </div>
