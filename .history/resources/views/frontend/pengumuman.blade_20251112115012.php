                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border text-center">
                        ...
                        <a href="{{ asset('storage/' . $item->file_pdf) }}" 
                           target="_blank" class="text-green-600 hover:underline">Lihat PDF</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div>
        ...
        <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
                @if ($item->gambar)
                    <img src="{{ asset('storage/' . $item->gambar) }}" alt="Gambar Pengumuman" class="h-48 w-full object-cover">
                @endif
                <div class="p-4">
                ...
                <div class="px-4 py-2 bg-gray-100 text-xs text-gray-500">
