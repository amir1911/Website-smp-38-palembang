...
<!-- ========================================
     ...
     ======================================== -->
<section 
    class="py-10 sm:py-12 md:py-14 bg-gradient-to-b from-[#1D4E89] to-[#DBEDFF] relative overflow-hidden"
    x-data="{ 
        scrollLeft() { $refs.carousel.scrollBy({ left: -350, behavior: 'smooth' }) }, 
        scrollRight() { $refs.carousel.scrollBy({ left: 350, behavior: 'smooth' }) } 
    }">

    <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white text-center mb-6 sm:mb-8 drop-shadow-lg" data-aos="fade-up">
        ...
        <div class="bg-[#1D4E89] rounded-3xl px-8 sm:px-12 py-6 sm:py-8 shadow-2xl">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                ...
                <div 
                    ...
                    <div class="bg-white p-3 sm:p-4 rounded-2xl shadow-md mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300">
                        <img 
