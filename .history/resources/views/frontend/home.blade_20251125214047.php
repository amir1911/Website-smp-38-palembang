...
<!-- ========================================
     ...
     ======================================== -->
<section 
    class="py-12 sm:py-14 md:py-16 bg-gradient-to-b from-[#1D4E89] to-[#DBEDFF] relative overflow-hidden"
    x-data="{ 
        scrollLeft() { $refs.carousel.scrollBy({ left: -350, behavior: 'smooth' }) }, 
        scrollRight() { $refs.carousel.scrollBy({ left: 350, behavior: 'smooth' }) } 
    }">

    <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white text-center mb-8 sm:mb-10 drop-shadow-lg" data-aos="fade-up">
    ...
    <div 
        x-ref="carousel"
        class="max-w-7xl mx-auto flex gap-8 overflow-x-auto scrollbar-hide snap-x snap-mandatory scroll-smooth pb-6 px-6 cursor-grab active:cursor-grabbing">
...
<!-- ========================================
     KEUNGGULAN SEKOLAH
     ======================================== -->
<section class="py-8 sm:py-10 md:py-12 bg-[#DBEDFF]">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 sm:mb-8 text-[#1D4E89]" data-aos="fade-up">
            Keunggulan Sekolah
        </h2>

        <div class="bg-[#1D4E89] rounded-3xl px-8 sm:px-12 py-8 sm:py-10 shadow-2xl">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div 
                    ...
                    <div class="bg-white p-4 rounded-2xl shadow-md mb-3 group-hover:scale-110 transition-transform duration-300">
                        <img 
                    ...
                    <h3 class="text-white font-bold text-lg sm:text-xl mb-2">
                        {{ $card['judul'] }}
                    </h3>
