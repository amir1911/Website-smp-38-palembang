...
<div>
  ...
  <!-- UBAH MENJADI BIRU -->
  <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-600 mb-4">
    PALEMBANG
  </h3>
</div>

<!-- Deskripsi -->
<p class="text-blue-700 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
  SMP Negeri 38 Palembang merupakan sekolah unggulan berbasis 
  <span class="font-semibold text-blue-800 relative">
    Kurikulum Merdeka
