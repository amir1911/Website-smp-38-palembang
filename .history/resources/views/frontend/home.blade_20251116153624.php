...
<!-- DESIGN OPTION 1: Modern Gradient dengan Decorative Elements -->
<section class="relative bg-gradient-to-br from-[#3B82F6] via-[#49ADFF] to-[#06B6D4] text-white py-12 sm:py-16 md:py-20 lg:py-24 font-[Poppins] overflow-hidden">
  ...
  <div class="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center px-4 sm:px-6 md:px-8">
    ...
    <div class="flex flex-col items-center" data-aos="fade-right" data-aos-duration="800">
      ...
      <h2 class="mt-8 text-xl sm:text-2xl md:text-3xl font-semibold">Windah</h2>
...
<!-- DESIGN OPTION 2: Minimalist Clean -->
<section class="bg-white text-gray-800 py-12 sm:py-16 md:py-20 lg:py-24 font-[Poppins] overflow-hidden">
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center px-4 sm:px-6 md:px-8">

    <!-- Foto Kepala Sekolah -->
    <div class="flex flex-col items-center" data-aos="fade-right" data-aos-duration="800">
      <div class="relative group">
        <div class="absolute -inset-2 bg-gradient-to-r from-[#49ADFF] to-[#06B6D4] rounded-2xl transform rotate-3 group-hover:rotate-6 transition-transform duration-500"></div>
        <div class="relative bg-white p-3 rounded-2xl shadow-2xl transform -rotate-2 group-hover:rotate-0 transition-transform duration-500">
          <div class="border-4 border-gray-100 rounded-xl overflow-hidden w-[240px] sm:w-[280px] md:w-[320px] lg:w-[380px] xl:w-[420px]">
            <img src="{{ asset('storage/guru/windah.jpg') }}" 
                 alt="Kepala Sekolah" 
                 class="w-full h-[240px] sm:h-[280px] md:h-[340px] lg:h-[400px] object-cover grayscale hover:grayscale-0 transition-all duration-700">
          </div>
        </div>
      </div>
      <h2 class="mt-6 text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Windah</h2>
      <p class="text-sm sm:text-base text-[#49ADFF] mt-1 font-semibold">Kepala Sekolah</p>
    </div>

    <!-- Teks Sambutan -->
    <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
      <div class="inline-block px-4 py-2 bg-[#49ADFF]/10 text-[#49ADFF] rounded-full text-sm font-semibold mb-4">
        Sambutan
      </div>
      <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 text-gray-900">Kepala Sekolah</h3>
      <div class="border-l-4 border-[#49ADFF] pl-4 mb-4">
        <p class="italic text-sm sm:text-base md:text-lg text-gray-600">Assalamu'alaikum warahmatullahi wabarakatuh</p>
      </div>
      <p class="text-justify text-sm sm:text-base md:text-lg leading-relaxed mb-3 text-gray-700">
        Puji syukur kita panjatkan ke hadirat Allah SWT, karena atas rahmat dan karunia-Nya,
        SMP Negeri 38 Palembang dapat terus berkomitmen memberikan pendidikan terbaik bagi
        generasi penerus bangsa...
      </p>
...
<!-- DESIGN OPTION 3: Dark Elegant -->
<section class="bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 text-white py-12 sm:py-16 md:py-20 lg:py-24 font-[Poppins] overflow-hidden relative">
  
  <!-- Grid Pattern -->
  <div class="absolute inset-0 opacity-5" style="background-image: linear-gradient(#49ADFF 1px, transparent 1px), linear-gradient(90deg, #49ADFF 1px, transparent 1px); background-size: 50px 50px;"></div>
  ...
  <div class="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center px-4 sm:px-6 md:px-8">
    ...
    <div class="flex flex-col items-center" data-aos="fade-right" data-aos-duration="800">
      <div class="relative">
        <div class="absolute inset-0 bg-gradient-to-r from-[#49ADFF] to-[#06B6D4] rounded-2xl blur-xl opacity-50"></div>
        <div class="relative border-4 border-[#49ADFF] rounded-2xl overflow-hidden shadow-2xl w-[240px] sm:w-[280px] md:w-[320px] lg:w-[380px] xl:w-[420px] transform hover:scale-105 transition-all duration-700">
          <img src="{{ asset('storage/guru/windah.jpg') }}" 
               alt="Kepala Sekolah" 
               class="w-full h-[240px] sm:h-[280px] md:h-[340px] lg:h-[400px] object-cover">
        </div>
      </div>
      <h2 class="mt-6 text-xl sm:text-2xl md:text-3xl font-semibold bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent">Windah</h2>
      <p class="text-sm sm:text-base text-[#49ADFF] mt-1">Kepala Sekolah</p>
    </div>

    <!-- Teks Sambutan -->
    <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
      <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4">Sambutan Kepala Sekolah</h3>
      <p class="italic mb-4 text-sm sm:text-base md:text-lg text-cyan-200">Assalamu'alaikum warahmatullahi wabarakatuh</p>
...
<section class="bg-gradient-to-br from-blue-50 to-cyan-50 py-12 sm:py-16 md:py-20 lg:py-24 font-[Poppins] overflow-hidden">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
    
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden" data-aos="zoom-in" data-aos-duration="1000">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">

        <!-- Foto Kepala Sekolah -->
        <div class="bg-gradient-to-br from-[#49ADFF] to-[#06B6D4] flex flex-col items-center justify-center p-8 sm:p-12 relative">
          <div class="absolute top-0 left-0 w-32 h-32 border-t-4 border-l-4 border-white/30 rounded-tl-3xl"></div>
          <div class="absolute bottom-0 right-0 w-32 h-32 border-b-4 border-r-4 border-white/30 rounded-br-3xl"></div>
          
          <div class="relative z-10">
            <div class="absolute inset-0 bg-white/20 rounded-2xl blur-xl"></div>
            <div class="relative border-4 border-white/50 rounded-2xl overflow-hidden shadow-2xl w-[240px] sm:w-[280px] md:w-[320px]">
              <img src="{{ asset('storage/guru/windah.jpg') }}" 
                   alt="Kepala Sekolah" 
                   class="w-full h-[240px] sm:h-[280px] md:h-[340px] object-cover">
            </div>
          </div>

          <div class="relative z-10 mt-6 bg-white rounded-xl px-6 py-3 shadow-xl">
            <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 text-center">Windah</h2>
            <p class="text-sm sm:text-base text-[#49ADFF] mt-1 text-center font-semibold">Kepala Sekolah</p>
          </div>
        </div>

        <!-- Teks Sambutan -->
        <div class="p-8 sm:p-12" data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
          <div class="inline-flex items-center gap-2 bg-[#49ADFF]/10 text-[#49ADFF] px-4 py-2 rounded-full text-sm font-semibold mb-4">
          ...
          <h3 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4 text-gray-900">Sambutan Kepala Sekolah</h3>
          
          <div class="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg mb-4">
            <p class="italic text-sm sm:text-base md:text-lg text-gray-700">Assalamu'alaikum warahmatullahi wabarakatuh</p>
          </div>
...
<!-- DESIGN OPTION 5: Split Screen Bold -->
<section class="bg-[#49ADFF] text-white py-12 sm:py-16 md:py-20 lg:py-24 font-[Poppins] overflow-hidden relative">
  
  <!-- Diagonal Split Background -->
  <div class="absolute inset-0 bg-gradient-to-br from-[#49ADFF] to-[#06B6D4]"></div>
  <div class="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-white/10"></div>
  ...
  <div class="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center px-4 sm:px-6 md:px-8">
    ...
    <div class="flex flex-col items-center" data-aos="fade-right" data-aos-duration="800">
      <div class="relative group">
        <div class="absolute -inset-2 bg-white/20 rounded-2xl transform rotate-6 group-hover:rotate-12 transition-transform duration-500"></div>
        <div class="absolute -inset-2 bg-white/10 rounded-2xl transform -rotate-6 group-hover:-rotate-12 transition-transform duration-500"></div>
        
        <div class="relative border-4 border-cyan-300 rounded-2xl overflow-hidden shadow-2xl w-[240px] sm:w-[280px] md:w-[320px] lg:w-[380px] xl:w-[420px] transform hover:scale-105 transition-all duration-700">
          <img src="{{ asset('storage/guru/windah.jpg') }}" 
               alt="Kepala Sekolah" 
               class="w-full h-[240px] sm:h-[280px] md:h-[340px] lg:h-[400px] object-cover">
          
          <!-- Overlay on hover -->
          <div class="absolute inset-0 bg-gradient-to-t from-[#49ADFF]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
            <div>
              <p class="text-white font-bold text-lg">Windah</p>
              <p class="text-cyan-100 text-sm">Kepala Sekolah</p>
            </div>
          </div>
        </div>
      </div>
      
      <h2 class="mt-4 text-xl sm:text-2xl md:text-3xl font-semibold">Windah</h2>
      <p class="text-sm sm:text-base text-cyan-200 mt-1">Kepala Sekolah</p>
    </div>
    ...
    <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
      <div class="mb-4">
        <div class="w-16 h-1 bg-yellow-400 mb-3"></div>
        <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4">Sambutan Kepala Sekolah</h3>
      </div>
      
      <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-4 border-l-4 border-yellow-400">
        <p class="italic text-sm sm:text-base md:text-lg">Assalamu'alaikum warahmatullahi wabarakatuh</p>
      </div>
      
      <p class="text-justify text-sm sm:text-base md:text-lg leading-relaxed mb-3 bg-white/5 backdrop-blur-sm rounded-xl p-4">
        Puji syukur kita panjatkan ke hadirat Allah SWT, karena atas rahmat dan karunia-Nya,
        SMP Negeri 38 Palembang dapat terus berkomitmen memberikan pendidikan terbaik bagi
        generasi penerus bangsa...
      </p>
