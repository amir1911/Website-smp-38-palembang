...
<div class="min-h-screen w-full pt-24 pb-32 px-4 md:px-8"
     style="background: linear-gradient(180deg, #5A8AC7 0%, #7BA3D4 30%, #A8C8E8 60%, #C9DDF2 100%);">

    <!-- Card utama dengan border radius besar -->
    <div class="max-w-5xl mx-auto bg-white/95 rounded-[40px] shadow-2xl p-8 md:p-12 backdrop-blur-sm">

        <div class="flex flex-col md:flex-row gap-8 items-start">

            <!-- Gambar sekolah -->
            <div class="w-full md:w-[45%] flex-shrink-0">
                <div class="rounded-[20px] overflow-hidden shadow-lg border-4 border-white">
                    <img 
