...
<section 
    ...
    class="w-full px-4 md:px-8 py-10 font-[Poppins]">
    ...
    <div class="relative max-w-5xl mx-auto">
        ...
        <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
            <div 
                ...
                class="relative w-full h-[260px] sm:h-[340px] md:h-[420px] lg:h-[470px] 
                       rounded-2xl shadow-xl overflow-hidden bg-gray-200">
                ...
                <!-- Title -->
                <div class="absolute bottom-0 w-full text-center p-6">
                    <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-white drop-shadow-lg"
                        x-text="item.judul">
                    </h3>
                </div>
        ...
        <div class="absolute inset-0 flex justify-between items-center px-3 pointer-events-none">
            ...
            <button @click="current = current === 1 ? total : current - 1"
                class="pointer-events-auto bg-white/80 hover:bg-white text-primary shadow-lg
                       rounded-full p-2 md:p-3 transition-all duration-300 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" 
                     class="w-4 h-4 md:w-5 md:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
