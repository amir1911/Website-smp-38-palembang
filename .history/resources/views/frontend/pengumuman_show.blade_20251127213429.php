...
@if ($pengumuman->instagram_link)
    <div class="mt-10">
        <div class="rounded-xl border border-blue-200 p-4 bg-blue-50">
            <h3 class="text-xl font-bold text-gray-800 mb-3">Postingan Instagram</h3>
            <p class="text-sm text-gray-600 mb-4">Pengumuman ini memiliki postingan terkait di Instagram:</p>
