...
@section('content')
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"
        integrity="sha512-Ml4bPQ4mHwCBcGvYCBef7hZ1VGpBkhFwU8ZzRY7r5cE1aM9y3fAtK7hP6Hu3B3TQhJHjv72EdbDe8eHqavHOAw=="
    ...
    <section class="py-20 font-[Poppins] -mb-20"
        ...
        <div class="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
            ...
            <div class="lg:col-span-3 space-y-8 order-1" data-aos="fade-right">
                ...
                <p class="text-white/100 leading-relaxed text-justify text-sm sm:text-base">
                    SMP Negeri 38 Palembang merupakan sekolah unggulan yang berkomitmen membentuk generasi berkarakter,
                    cerdas, dan berdaya saing.
                    Berlokasi strategis di wilayah Palembang, sekolah kami dilengkapi dengan berbagai fasilitas modern untuk
                    mendukung kegiatan belajar mengajar.
                </p>

                {{-- Google Map --}}
                <div
                    class="rounded-2xl overflow-hidden shadow-md border border-white/20 hover:shadow-xl transition duration-500">
                    <iframe
            ...
            <div class="lg:col-span-2 bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition duration-500 order-2"
                data-aos="fade-left">
                <h2 class="text-2xl font-bold mb-4 text-[#4C8BBE]">Kontak Kami</h2>
                ...
                <div class="flex justify-center space-x-6 mt-6">
                    <a href="https://www.facebook.com/groups/262960747172852/?ref=share&mibextid=NSMWBT" target="_blank" class="text-[#4C8BBE] hover:text-[#1f7bd6] text-xl transition"><i
                            class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/smpn38_palembang?igsh=aXl3aGlseG9xdDI5" target="_blank" class="text-[#4C8BBE] hover:text-[#1f7bd6] text-xl transition"><i
                            class="fab fa-instagram"></i></a>
                    <a href="https://www.tiktok.com/@spentipanplg?is_from_webapp=1&sender_device=pc" target="_blank" class="text-[#4C8BBE] hover:text-[#1f7bd6] text-xl transition"><i
