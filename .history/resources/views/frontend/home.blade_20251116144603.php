...
<section class="relative w-full overflow-hidden font-[Poppins]"
    ...
    <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
        <div 
            ...
            class="relative w-full h-[280px] sm:h-[400px] md:h-[520px] lg:h-[600px] xl:h-[680px]">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                <div class="backdrop-blur-md bg-white/10 px-6 py-3 rounded-xl shadow-xl border border-white/20">
                    <h3 class="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white drop-shadow-lg"
    ...
    <!-- Navigation Buttons -->
    <div class="absolute inset-0 flex justify-between items-center px-3 sm:px-6 pointer-events-none">

        <!-- Left -->
        <button @click="current = current === 1 ? total : current - 1"
            class="pointer-events-auto bg-white/20 backdrop-blur-lg hover:bg-white/40 text-white
                   shadow-xl rounded-full p-2 sm:p-3 md:p-4 transition-all duration-300 hover:scale-110">
