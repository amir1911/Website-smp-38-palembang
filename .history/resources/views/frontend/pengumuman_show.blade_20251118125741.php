...
@section('content')
<section class="min-h-screen bg-gradient-to-br from-blue-50 to-sky-100 py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- Breadcrumb -->
        <nav class="mb-6">
            <div class="flex items-center gap-2 text-sm bg-white px-4 py-2 rounded-lg shadow-sm w-fit">
        ...
        <!-- Alert Banner -->
        <div class="mb-6">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-5 shadow-lg">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-8">
                <div class="mb-3">
                    <span class="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-1 rounded-full text-white text-sm font-medium">
            ...
            <div class="p-8">
                ...
                <div class="prose max-w-none">
                    <div class="text-gray-700 leading-relaxed bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
                ...
                <div class="mt-8">
                    <div class="bg-blue-500 rounded-lg p-5 mb-4">
                    ...
                    <div class="flex flex-wrap gap-3 mt-4">
                        ...
                        <button onclick="printPDF()" 
                                class="bg-gray-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-gray-700 transition">
            ...
            <!-- Important Notice -->
            <div class="bg-blue-50 border-t-4 border-blue-500 p-5 mx-6 mb-6 rounded-lg">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <button onclick="copyLink()" 
                            class="col-span-2 bg-gray-700 text-white px-4 py-3 rounded-lg font-medium hover:bg-gray-800 transition">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2">
                    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" 
                            class="w-full bg-blue-500 text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-600 transition">
...
<!-- Toast Notification -->
<div id="toast" class="fixed bottom-6 right-6 bg-blue-600 text-white px-6 py-4 rounded-lg shadow-xl transform translate-y-32 transition-transform duration-300 flex items-center gap-3 z-50">
