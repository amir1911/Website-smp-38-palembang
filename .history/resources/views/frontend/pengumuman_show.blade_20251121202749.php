...
<section class="min-h-screen py-8 -mb-20"
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Alert Banner -->
        <div class="mb-6">
            <div class="rounded-xl p-5 shadow-lg"
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100">
            ...
            <div class="p-8">
                ...
                <div class="mt-8">
                    <div class="rounded-lg p-5 mb-4" style="background: linear-gradient(90deg, #1A4E8A 0%, #2575B8 100%);">
...
<!-- Toast Notification -->
<div id="toast" class="fixed bottom-6 right-6 text-white px-6 py-4 rounded-lg shadow-xl transform translate-y-32 transition-transform duration-300 flex items-center gap-3 z-50 border border-white/30"
     style="background: linear-gradient(90deg, #1A4E8A 0%, #2575B8 100%);">
