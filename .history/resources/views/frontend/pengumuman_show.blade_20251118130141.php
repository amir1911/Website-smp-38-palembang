...
@section('content')
<section class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- Breadcrumb -->
        <nav class="mb-6">
            <div class="flex items-center gap-2 text-sm bg-white px-4 py-2 rounded-lg shadow-sm w-fit border border-blue-200">
        ...
        <!-- Alert Banner -->
        <div class="mb-6">
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-5 shadow-lg">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-200">
            ...
            <div class="p-8">
                ...
                <div class="prose max-w-none">
                    <div class="text-gray-700 leading-relaxed bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-lg border-l-4 border-blue-500">
                ...
                <div class="mt-8">
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg p-5 mb-4">
                    ...
                    <div class="rounded-lg overflow-hidden border-2 border-blue-300 bg-gray-50">
                        <iframe 
                    ...
                    <div class="flex flex-wrap gap-3 mt-4">
                        ...
                        <button onclick="printPDF()" 
                                class="bg-indigo-500 text-white px-6 py-2 rounded-lg font-medium hover:bg-indigo-600 transition">
            ...
            <!-- Important Notice -->
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-t-4 border-blue-500 p-5 mx-6 mb-6 rounded-lg">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border border-blue-200">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <button onclick="copyLink()" 
                            class="col-span-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-3 rounded-lg font-medium hover:from-blue-600 hover:to-indigo-700 transition">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border border-blue-200">
                ...
                <div class="space-y-2">
                    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" 
                            class="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-3 rounded-lg font-medium hover:from-blue-600 hover:to-indigo-700 transition">
...
<!-- Toast Notification -->
<div id="toast" class="fixed bottom-6 right-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-4 rounded-lg shadow-xl transform translate-y-32 transition-transform duration-300 flex items-center gap-3 z-50 border border-white/30">
