...
<section class="max-w-6xl mx-auto mt-12 px-6">
  <h2 class="text-2xl md:text-3xl font-bold text-center mb-6 text-[#49ADFF]" data-aos="fade-up">
    Kegiatan Ekstrakurikuler
  </h2>

  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    @foreach($ekstrakurikulers as $item)
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition transform hover:-translate-y-2 duration-500" data-aos="zoom-in">
        ...
        <div class="p-4 text-center">
          <h3 class="text-lg font-semibold text-gray-800">{{ $item->nama_kegiatan }}</h3>
