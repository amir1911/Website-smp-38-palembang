...
<section class="bg-gradient-to-br from-white via-blue-50/30 to-cyan-50/50 py-16 sm:py-20 md:py-24 lg:py-28 font-poppins overflow-hidden relative">
  
  <!-- Decorative Background Elements -->
  <div class="absolute top-0 left-0 w-64 h-64 bg-[#49ADFF]/5 rounded-full blur-3xl"></div>
  <div class="absolute bottom-0 right-0 w-96 h-96 bg-cyan-400/5 rounded-full blur-3xl"></div>
  <div class="absolute top-1/2 left-1/4 w-32 h-32 border-2 border-[#49ADFF]/10 rounded-full"></div>
  
  <div class="max-w-7xl mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center px-4 sm:px-6 md:px-8 relative z-10">

    <!-- Kiri: Teks Profil -->
    <div data-aos="fade-right" data-aos-duration="800" class="text-center lg:text-left">
      
      <!-- Badge -->
      <div class="inline-flex items-center gap-2 bg-[#49ADFF]/10 text-[#49ADFF] px-4 py-2 rounded-full mb-6 border border-[#49ADFF]/20">
        <div class="w-2 h-2 bg-[#49ADFF] rounded-full animate-pulse"></div>
        <span class="text-sm font-semibold">Sekolah Unggulan</span>
      </div>

      <!-- Title -->
      <h2 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gradient mb-2 leading-tight">
        SMP NEGERI 38
      </h2>
      <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 mb-6">
        PALEMBANG
      </h3>

      <!-- Decorative Line -->
      <div class="flex items-center gap-3 mx-auto lg:mx-0 w-fit mb-8">
        <div class="h-1 w-16 bg-gradient-to-r from-[#49ADFF] to-transparent rounded-full"></div>
        <div class="w-3 h-3 bg-[#49ADFF] rounded-full"></div>
        <div class="h-1 w-16 bg-gradient-to-l from-[#49ADFF] to-transparent rounded-full"></div>
      </div>

      <!-- Description -->
      <p class="text-gray-600 text-base sm:text-lg md:text-xl mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
        SMP Negeri 38 Palembang merupakan sekolah unggulan berbasis 
        <span class="font-semibold text-[#49ADFF]">Kurikulum Merdeka</span> yang berkomitmen membentuk generasi
        berkarakter, mandiri, dan kreatif dalam menghadapi tantangan masa depan.
      </p>

      <!-- Features Grid -->
      <div class="grid grid-cols-3 gap-4 mb-8 max-w-lg mx-auto lg:mx-0">
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          <div class="text-2xl mb-2">🎓</div>
          <p class="text-xs font-semibold text-gray-700">Kurikulum Merdeka</p>
        </div>
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          <div class="text-2xl mb-2">⭐</div>
          <p class="text-xs font-semibold text-gray-700">Akreditasi A</p>
        </div>
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          <div class="text-2xl mb-2">🏆</div>
          <p class="text-xs font-semibold text-gray-700">Prestasi Unggulan</p>
        </div>
      </div>

      <!-- CTA Button -->
      <a href="/profile"
         class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#49ADFF] to-[#2D8FD7] text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 text-base sm:text-lg font-semibold group">
        Selengkapnya
    ...
    <!-- Kanan: Logo Sekolah -->
    <div class="flex justify-center mb-10 lg:mb-0" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="200">
      <div class="relative">
        
        <!-- Decorative Circles Behind Logo -->
        <div class="absolute -top-6 -left-6 w-32 h-32 bg-[#49ADFF]/10 rounded-full blur-2xl"></div>
        <div class="absolute -bottom-6 -right-6 w-40 h-40 bg-cyan-400/10 rounded-full blur-2xl"></div>
        
        <!-- Logo Container -->
        <div class="relative bg-gradient-to-br from-white via-blue-50 to-cyan-50 shadow-2xl rounded-3xl p-8 sm:p-10 md:p-12 hover:scale-105 transition-all duration-500 animate-pulse-glow border border-white">
          
          <!-- Inner Glow Effect -->
          <div class="absolute inset-0 bg-gradient-to-br from-[#49ADFF]/5 to-transparent rounded-3xl"></div>
          
          <!-- Logo -->
          <div class="relative z-10">
            <img src="https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?w=500&h=500&fit=crop" 
                 alt="Logo Sekolah"
                 class="w-[220px] sm:w-[280px] md:w-[340px] lg:w-[400px] h-auto object-contain mx-auto animate-float drop-shadow-2xl">
          </div>
          
          <!-- Decorative Corner Elements -->
          <div class="absolute top-4 right-4 w-4 h-4 border-t-2 border-r-2 border-[#49ADFF]/30"></div>
          <div class="absolute bottom-4 left-4 w-4 h-4 border-b-2 border-l-2 border-[#49ADFF]/30"></div>
        </div>

        <!-- Floating Badge -->
        <div class="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-white px-6 py-2 rounded-full shadow-lg border-2 border-[#49ADFF]/20">
          <p class="text-sm font-bold text-[#49ADFF]">Est. 1985</p>
        </div>
      </div>
    </div>
