...
<section class="relative w-full overflow-hidden font-[Poppins] bg-gradient-to-b from-white via-blue-50/30 to-white" 
    ...
    <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
        <div 
            ...
            <div class="relative w-full h-full overflow-hidden mx-auto max-w-[98%] sm:max-w-7xl
                        rounded-2xl sm:rounded-3xl
                        shadow-[0_10px_60px_rgba(30,64,175,0.15)]">
            ...
            <div class="absolute inset-0 flex items-end pb-12 sm:pb-16 md:pb-20 px-6 sm:px-8 md:px-12 lg:px-16">
                <div class="w-full max-w-7xl mx-auto">
                    ...
                    <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white 
                               ...
                               animate-[slideInLeft_0.8s_ease-out_0.1s_both]" 
                        x-text="item.judul"></h2>

                    <!-- Description -->
                    <p class="text-sm sm:text-base md:text-lg text-blue-50 max-w-2xl
                              drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]
                              leading-relaxed
                              animate-[slideInLeft_1s_ease-out_0.2s_both]"
                    ...
                    <div class="flex flex-wrap gap-3 sm:gap-4 mt-5 sm:mt-6 animate-[slideInLeft_1.2s_ease-out_0.3s_both]">
                        <button class="group bg-blue-600 hover:bg-blue-700 text-white font-semibold 
                                       px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg sm:rounded-xl
                        ...
                        <button class="group bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white font-semibold 
                                       px-5 sm:px-7 py-2.5 sm:py-3 rounded-lg sm:rounded-xl
