...
<section class="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-[#1D4E89] to-[#DCEBFA]">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 text-center">

    <!-- Judul -->
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-14"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div 
        ...
        class="flex flex-col items-center text-center p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
        ...
        <h3 class="text-[#1D4E89] font-bold text-xl mb-2">
          {{ $card['judul'] }}
        </h3>
