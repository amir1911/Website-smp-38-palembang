...
<div class="min-h-screen flex items-center justify-center font-[Poppins] px-4 py-10 -mb-20"
  ...
  <div class="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-2xl border-2 border-[#4C8BBE] hover:shadow-[#4C8BBE]/50 transition-all duration-300">
    ...
    <form action="{{ route('buku-tamu.store') }}" method="POST" class="space-y-6 animate-fade-in">
      ...
      {{-- Bagian Kamera --}}
      <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border-2 border-[#4C8BBE] shadow-inner">
        ...
        <div class="text-center">
          <div class="relative inline-block">
            ...
            <div class="absolute -bottom-2 -right-2 w-8 h-8 bg-[#4C8BBE] rounded-full flex items-center justify-center shadow-lg">
