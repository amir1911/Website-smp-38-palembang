...
<section 
    ...
    class="w-full py-10 font-[Poppins]">
    ...
    <div class="relative max-w-5xl mx-auto px-4">
        ...
        <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
            <div 
                ...
                class="relative w-full h-[260px] sm:h-[340px] md:h-[450px] lg:h-[520px]
                       rounded-3xl overflow-hidden shadow-2xl bg-black">

                <!-- Background Image -->
                <img 
                    :src="'/storage/' + item.gambar"
                    class="w-full h-full object-cover brightness-[0.65]
                           transition duration-700 ease-out hover:scale-105">
                ...
                <div class="absolute bottom-6 left-0 right-0 flex justify-center px-4">
                    <div class="backdrop-blur-xl bg-white/20 border border-white/20
                                px-6 py-3 rounded-2xl shadow-xl max-w-xl text-center">
                        <h3 class="text-lg sm:text-2xl md:text-3xl font-bold text-white drop-shadow-lg"
                            x-text="item.judul">
                        </h3>
        ...
        <button 
            ...
            class="absolute left-2 top-1/2 -translate-y-1/2
                   ...
                   rounded-full p-3 md:p-4 shadow-lg 
                   hover:bg-white transition hover:scale-110">
