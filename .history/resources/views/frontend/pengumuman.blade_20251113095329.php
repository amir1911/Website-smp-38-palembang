...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="bg-white shadow-2xl rounded-2xl p-6 lg:p-8 mb-12 border border-gray-100">
        ...
        {{-- Footer Info --}}
        <div class="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 bg-blue-50 rounded-xl p-4 border border-blue-100">
            <div class="flex items-center text-sm text-gray-700">
                <div class="bg-green-500 rounded-full w-2.5 h-2.5 mr-2 animate-pulse"></div>
                <span class="font-semibold">Total {{ $pengumumanPdf->count() }} dokumen tersedia</span>
            </div>
