...
<section 
    ...
    x-init="setInterval(() => current = current === total ? 1 : current + 1, 4800)"
    class="w-full px-4 md:px-10 py-12 font-[Poppins]">
    ...
    <div class="relative max-w-6xl mx-auto">
        ...
        <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
            <div 
                ...
                class="relative w-full h-[260px] sm:h-[340px] md:h-[450px] lg:h-[520px]
                       rounded-3xl overflow-hidden shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)]
                ...
                <!-- Modern cinematic gradient -->
                <div class="absolute inset-0 bg-gradient-to-br 
                            from-black/60 via-black/20 to-transparent"></div>

                <!-- Glass Info Box -->
                <div class="absolute bottom-6 left-0 right-0 flex justify-center">
                    <div class="backdrop-blur-xl bg-white/15 border border-white/20 
                                px-6 py-4 rounded-2xl shadow-xl 
                                transform transition-all duration-500 hover:scale-[1.02]">

                        <h3 class="text-xl sm:text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg"
                            x-text="item.judul">
                        </h3>

                        <p class="mt-1 text-white/80 text-sm sm:text-base">
                            Slide preview – informasi singkat kegiatan sekolah
                        </p>
                    </div>
                </div>
        ...
        <div class="absolute inset-0 flex justify-between items-center px-4 pointer-events-none">
            ...
            <button 
                ...
                class="pointer-events-auto bg-white/20 backdrop-blur-lg 
                       hover:bg-white/40 text-white shadow-xl
                       rounded-full p-3 md:p-4 transition-all duration-300 
                       hover:scale-110 hover:shadow-[0_0_20px_#ffffff80]">
    ...
    <div class="flex justify-center mt-6 space-x-3">
        <template x-for="i in total">
            <button 
                ...
                :class="current === i 
                    ? 'bg-gradient-to-r from-blue-400 to-blue-600 shadow-[0_0_10px_#3b82f6] scale-125' 
