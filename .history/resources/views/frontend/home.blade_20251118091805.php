        ...
        x-data="{ 
            ...
            ekstrakurikulers: [
                { 
                    ...
                    foto: '/api/placeholder/340/280',
                    deskripsi: 'Kegiatan kepramukaan untuk membentuk karakter kepemimpinan dan kemandirian siswa'
                },
                { 
                    nama_kegiatan: 'Basket', 
                    foto: '/api/placeholder/340/280',
                    deskripsi: 'Olahraga basket untuk melatih kerjasama tim dan sportivitas'
                },
                { 
                    nama_kegiatan: 'Seni Tari', 
                    foto: '/api/placeholder/340/280',
                    deskripsi: 'Mengembangkan bakat seni tari tradisional dan modern'
                },
                { 
                    nama_kegiatan: 'Robotika', 
                    foto: '/api/placeholder/340/280',
                    deskripsi: 'Melatih kemampuan teknologi dan programming untuk masa depan'
                },
                { 
                    nama_kegiatan: 'Teater', 
                    foto: '/api/placeholder/340/280',
                    deskripsi: 'Mengasah kemampuan akting dan kepercayaan diri di atas panggung'
                },
                { 
                    nama_kegiatan: 'Futsal', 
                    foto: '/api/placeholder/340/280',
                    deskripsi: 'Olahraga futsal untuk kebugaran dan kekompakan tim'
                }
            ]
        }"
    >
        ...
        >
            <template x-for="(item, index) in ekstrakurikulers" :key="index">
                <div 
                ...
                >
                    <!-- Gambar -->
                    <div class="flex items-center justify-center h-48 sm:h-52 md:h-56 bg-gradient-to-br from-[#f7fbff] to-[#eef5ff] rounded-t-3xl overflow-hidden">
                        <img 
                            :src="item.foto" 
                    ...
                    <div class="p-5 text-center select-none">
                        <h3 class="text-base sm:text-lg md:text-xl font-semibold text-gray-800 mb-2" x-text="item.nama_kegiatan">
                        </h3>
                        <p class="text-gray-600 text-sm md:text-base leading-relaxed" x-text="item.deskripsi">
                        </p>
                    </div>
                </div>
            </template>
