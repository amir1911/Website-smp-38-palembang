...
<section class="bg-[#49ADFF] text-white py-12 sm:py-16 md:py-20 lg:py-24 font-poppins relative overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center px-4 sm:px-6 md:px-8 relative z-10">
    ...
    <!-- Foto Kepala Sekolah -->
    <div class="flex flex-col items-center lg:items-start" data-aos="fade-right" data-aos-duration="800">
      
      <!-- Title Above Photo -->
      <div class="mb-6 text-center lg:text-left">
        <span class="inline-block px-4 py-2 bg-white text-[#49ADFF] rounded-full text-sm font-semibold mb-3 shadow-lg">
          👋 Selamat Datang
        </span>
      ...
      <!-- Role Badge -->
      <div class="mt-8 flex items-center gap-3 bg-white/20 backdrop-blur-sm px-5 py-3 rounded-full border border-white/30">
        <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
        <p class="text-sm sm:text-base font-semibold text-center">Kepala Sekolah</p>
    ...
    <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
      ...
      {{-- <!-- Greeting Box -->
      <div class="bg-white/95 text-[#49ADFF] rounded-2xl p-6 mb-6 shadow-xl border-l-4 border-cyan-400">
        <p class="text-lg sm:text-xl md:text-2xl font-semibold italic">
          ✨ Assalamu'alaikum warahmatullahi wabarakatuh
        </p>
      </div> --}}

      <!-- Content Card -->
      <div class="bg-white/15 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/30">
        
        <div class="space-y-5 text-sm sm:text-base md:text-lg leading-relaxed">
          <p>Assalamu'alaikum warahmatullahi wabarakatuh</p>
          <p class="text-justify animate-slide-up">
          ...
          <p class="text-justify animate-slide-up" style="animation-delay: 0.2s;">
          ...
          <p class="text-justify animate-slide-up" style="animation-delay: 0.4s;">
        ...
        <div class="mt-8 pt-6 border-t border-white/30">
          <p class="text-cyan-100 font-medium italic mb-4">
