...
@section('content')
<section class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 relative overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mb-8" data-aos="fade-down">
            <a href="{{ route('pengumuman.index') }}" 
               ...
               <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <!-- Header Card -->
        <div class="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl shadow-2xl overflow-hidden mb-10 transform hover:scale-[1.01] transition-all duration-500" data-aos="fade-up">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="mt-12 pt-10 border-t-2 border-gradient-to-r from-blue-200 via-indigo-200 to-purple-200" data-aos="fade-up">
                    <!-- PDF Header -->
                    <div class="flex items-center justify-between mb-8 flex-wrap gap-4">
                        ...
                        <a href="{{ asset('storage/' . $pengumuman->file_pdf) }}" 
                           download
                           class="inline-flex items-center gap-3 bg-gradient-to-br from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-2xl font-bold hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 hover:shadow-2xl transition-all duration-300 shadow-xl group">
                    ...
                    <!-- PDF Viewer -->
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-gradient-to-br from-blue-200 via-indigo-200 to-purple-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-2">
                        <iframe 
                    ...
                    <div class="flex flex-wrap gap-4 mt-6">
                        <a href="{{ asset('storage/' . $pengumuman->file_pdf) }}" 
                           target="_blank" 
                           class="flex items-center gap-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3.5 rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl group">
                           <i class="fas fa-external-link-alt group-hover:rotate-12 transition-transform"></i>
                           <span>Buka di Tab Baru</span>
                        </a>
                        <button onclick="printPDF()" 
                                class="flex items-center gap-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3.5 rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl group">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-10 mt-10 border border-gray-100" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <button onclick="shareToFacebook()" 
                        class="flex items-center gap-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-2xl font-bold hover:from-blue-700 hover:to-blue-800 transform hover:scale-105 hover:shadow-xl transition-all duration-300 shadow-lg group">
                    <i class="fab fa-facebook-f text-2xl group-hover:scale-110 transition-transform"></i>
                    <span>Facebook</span>
                </button>
                <button onclick="copyLink()" 
                        class="flex items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-2xl font-bold hover:from-purple-700 hover:to-pink-700 transform hover:scale-105 hover:shadow-xl transition-all duration-300 shadow-lg group">
        ...
        <div class="mt-10 text-center" data-aos="fade-up" data-aos-delay="300">
            <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" 
                    class="inline-flex items-center gap-3 bg-gradient-to-br from-indigo-600 to-purple-600 text-white px-10 py-5 rounded-2xl font-bold hover:from-indigo-700 hover:to-purple-700 transform hover:scale-105 hover:shadow-2xl transition-all duration-300 shadow-xl group">
...
<!-- Toast Notification -->
<div id="toast" class="fixed bottom-8 right-8 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-5 rounded-2xl shadow-2xl transform translate-y-32 transition-all duration-500 flex items-center gap-4 z-50 border-2 border-white/20">
...
::-webkit-scrollbar-track {
    background: linear-gradient(180deg, #EBF4FF 0%, #E0E7FF 100%);
}
...
.border-gradient-to-br {
    border-image: linear-gradient(to bottom right, #93C5FD, #A78BFA, #C084FC) 1;
}
