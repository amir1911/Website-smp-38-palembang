...
<div class="w-full px-4 sm:px-6 md:px-12 lg:px-20 py-12 sm:py-16 md:py-24 -mb-20"
    ...
    <!-- Badge kecil atas -->
    <div class="inline-block bg-white/20 backdrop-blur-sm px-6 sm:px-8 md:px-10 py-1.5 sm:py-2 rounded-full mb-3 border border-white/30 shadow-lg">
    ...
    <!-- Judul Utama -->
    <h2 class="text-white font-extrabold tracking-wide drop-shadow-lg
