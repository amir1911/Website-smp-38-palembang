                ...
                <div class="relative group mb-6">
                    ...
                    <div
                        ...
                        <div class="rounded-2xl overflow-hidden w-[280px] sm:w-[320px] md:w-[360px]">
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-blue-900/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500">
                            </div>
                        </div>

                        <div
                            class="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white text-[#1D4E89] px-8 py-3 rounded-full shadow-xl">
