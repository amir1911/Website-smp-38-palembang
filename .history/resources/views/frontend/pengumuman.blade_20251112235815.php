...
<section class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12 animate-fade-in">
            ...
            <h1 class="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
                Pengumuman Sekolah
            </h1>
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('pengumuman.index') }}" 
                       class="group relative px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105
                              {{ !isset($kategori) ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                    ...
                    @foreach ($kategoriList as $kat)
                        <a href="{{ route('pengumuman.byKategori', $kat->id) }}" 
                           class="group relative px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105
                                  {{ isset($kategori) && $kategori->id == $kat->id ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                            {{ $kat->nama_kategori }}
                        </a>
                    @endforeach
                </div>
                ...
                <div class="bg-gradient-to-r from-green-500 to-teal-600 px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-green-100 text-sm">File PDF yang dapat diunduh</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="animate-slide-up">
            ...
            <div class="flex items-center mb-6">
                <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-3 mr-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <!-- Read More Button -->
                        <a href="{{ route('pengumuman.show', $item->id) }}" 
                           class="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-700 group-hover:gap-2 transition-all duration-200">
                            Baca Selengkapnya 
        ...
        <div class="text-center py-16 animate-fade-in">
            <div class="inline-block mb-6">
                <div class="bg-gradient-to-br from-blue-100 to-purple-100 rounded-full p-8">
                    <i class="fas fa-inbox text-6xl text-blue-400"></i>
                </div>
            </div>
