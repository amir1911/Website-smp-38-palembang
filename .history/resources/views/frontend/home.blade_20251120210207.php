...
<section class="bg-[#DCEBFA] text-[#1D4E89] py-12 sm:py-16 md:py-20 lg:py-24 font-poppins relative overflow-hidden">

  <!-- Decorative Background -->
  <div class="absolute inset-0 opacity-10">
    <svg class="absolute bottom-0 w-full" viewBox="0 0 1440 320" fill="none">
      <path fill="#ffffff" fill-opacity="0.3"
        d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,138.7C960,139,1056,117,1152,101.3C1248,85,1344,75,1392,69.3L1440,64V320H0Z"/>
    </svg>
  </div>

  <div class="absolute top-20 left-10 w-16 h-16 border-4 border-[#1D4E89]/20 rounded-lg rotate-45"></div>
  <div class="absolute top-40 right-20 w-12 h-12 bg-[#33C3F8]/20 rounded-full"></div>

  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-4 sm:px-6 md:px-8 relative z-10">

    <!-- FOTO & NAMA -->
    <div class="flex flex-col items-center">

      <div class="mb-6 text-center">
        <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
          Sambutan <br/>
          <span class="text-[#2D6BB5]">Kepala Sekolah</span>
        </h3>
      </div>

      <div class="relative group mb-6">
        <div class="absolute inset-0 bg-gradient-to-br from-[#A6C9FF] to-[#2D6BB5] 
                    rounded-3xl rotate-3"></div>
        ...
        <div class="relative bg-white p-3 rounded-3xl shadow-2xl">
          <div class="rounded-2xl overflow-hidden w-[240px] sm:w-[280px] md:w-[320px] lg:w-[360px]">
            <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400"
                 class="w-full h-[280px] sm:h-[320px] md:h-[360px] lg:h-[400px] object-cover">

            <div class="absolute inset-0 bg-gradient-to-t
                        from-[#2D6BB5]/80 to-transparent opacity-0"></div>
          </div>

          <div class="absolute -bottom-4 left-1/2 -translate-x-1/2 
                      bg-white text-[#2D6BB5] px-6 py-3 rounded-full shadow-xl">
            <h2 class="text-xl sm:text-2xl font-bold">Windah</h2>
          </div>
        </div>
      </div>

      <div class="flex items-center gap-3 bg-white/30 px-6 py-3 
                  rounded-full border border-white/40 shadow-lg">
        <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
        <p class="text-sm sm:text-base font-semibold text-[#1D4E89]">Kepala Sekolah</p>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="bg-white/50 backdrop-blur-md rounded-3xl p-6 sm:p-8 md:p-10 
                  shadow-xl border border-white/50">

        <div class="space-y-5 text-sm sm:text-base md:text-lg leading-relaxed text-[#1D4E89]">
          <p class="italic text-[#2D6BB5] font-medium">
            Assalamu'alaikum warahmatullahi wabarakatuh
          </p>

          <p class="text-justify">
            Puji syukur kita panjatkan…
            <span class="font-semibold text-[#2D6BB5]">SMP Negeri 38 Palembang</span>
          </p>

          <p class="text-justify">
            Kami berupaya menciptakan lingkungan belajar…
          </p>
        ...
        <div class="mt-8 pt-6 border-t border-white/60">
          <p class="text-[#2D6BB5] font-medium italic mb-6">
            Wassalamu'alaikum warahmatullahi wabarakatuh
          </p>

          <div class="flex items-center gap-4">
            <div class="w-16 h-0.5 bg-[#33C3F8]"></div>
            <div>
              <p class="font-bold text-lg text-[#1D4E89]">Windah</p>
              <p class="text-sm text-[#2D6BB5]">Kepala SMP Negeri 38 Palembang</p>
            </div>
          </div>
        </div>
