...
@section('content')
    ...
    <img 
        src="{{ asset('storage/guru/kepalasekolah.jpeg') }}" 
        alt="Kepala Sekolah"
        class="w-full h-[320px] sm:h-[360px] md:h-[400px] object-cover group-hover:scale-105 transition duration-700">

    <div class="absolute inset-0 bg-gradient-to-t from-blue-900/60 via-transparent to-transparent 
