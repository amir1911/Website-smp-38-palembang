...
<div class="w-full px-4 sm:px-6 md:px-12 lg:px-20 py-12 sm:py-16 md:py-24 -mb-20"
    ...
    <!-- Badge kecil atas -->
    <div class="inline-block bg-white/20 backdrop-blur-sm px-6 sm:px-8 md:px-10 py-2 sm:py-3 rounded-full mb-3 border border-white/30 shadow-lg">
        <h1 class="text-white text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-extrabold tracking-wide drop-shadow-md">
            PENGUMUMAN SEKOLAH
        </h1>
    </div>

    <!-- Judul Utama -->
    <h2 class="text-white font-extrabold tracking-wide drop-shadow-xl
        ...
        <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-10 md:mb-12 mx-2 sm:mx-0">
        ...
        <div class="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 mx-2 sm:mx-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div class="group bg-gray-50 rounded-xl sm:rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200 hover:border-blue-300 flex flex-col">
                    ...
                    <div class="relative h-40 sm:h-48 overflow-hidden">
                        ...
                        <span class="absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-bold text-white shadow-md"
                              style="background: linear-gradient(90deg, #1A4E8A 0%, #2575B8 100%);">
                            {{ $item->kategori?->nama_kategori ?? '-' }}
                        </span>
                    </div>
                    ...
                    <div class="p-4 sm:p-5 flex-1 flex flex-col">
                        <h4 class="font-bold text-base sm:text-lg text-gray-800 mb-2 leading-tight group-hover:text-blue-600 transition-colors duration-300">
                            {{ $item->judul }}
                        </h4>
