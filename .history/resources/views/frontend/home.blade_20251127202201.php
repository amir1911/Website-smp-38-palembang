...
@section('content')
    ...
    <section class="bg-[#1D4E89] text-white py-16 sm:py-20 md:py-24 font-poppins relative overflow-hidden">
        ...
        <div
            class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center px-6 sm:px-8 relative z-10">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="relative group mb-6">
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-500 rounded-3xl rotate-3 group-hover:rotate-6 transition-all duration-500">
                    </div>

                    <div
                        class="relative bg-white p-3 rounded-3xl shadow-2xl group-hover:-translate-y-2 transition-all duration-500">
                        <div class="relative group rounded-2xl overflow-hidden w-[280px] sm:w-[320px] md:w-[360px]">
                            <img src="{{ asset('storage/guru/kepalasekolah.jpeg') }}" alt="Kepala Sekolah"
                                class="w-full h-[320px] sm:h-[360px] md:h-[400px] object-cover group-hover:scale-105 transition duration-700">

                            <div
                                class="absolute inset-0 bg-gradient-to-t from-blue-900/60 via-transparent to-transparent 
                opacity-0 group-hover:opacity-100 transition duration-500">
                        ...
                        <div
                            class="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white text-[#1D4E89]
           px-10 py-4 rounded-full shadow-xl min-w-[280px] sm:min-w-[320px]">
                            <h2 class="text-xl sm:text-2xl font-bold text-center leading-tight">
                ...
                <!-- Role Badge -->
                <div
                    class="flex items-center justify-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full border border-white/30 shadow-lg">
            ...
            <div>
                <div class="bg-white/10 backdrop-blur-md rounded-3xl p-8 sm:p-10 shadow-2xl border border-white/20">
                    <div class="space-y-5 text-sm sm:text-base leading-relaxed">
                        ...
                        <p class="text-justify text-white/90">
                            Kami berupaya menciptakan lingkungan belajar yang inovatif, inklusif, dan berprestasi. Dengan
                            dukungan tenaga pendidik profesional dan fasilitas memadai, kami yakin dapat mencetak generasi
                            yang unggul dalam akademik maupun karakter.
                        </p>
