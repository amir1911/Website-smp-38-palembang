    ...
    <form action="{{ route('buku-tamu.store') }}" method="POST" class="space-y-4">
      ...
      <div class="text-center">
        ...
        <div id="previewContainer" class="mt-4 hidden">
          ...
          <img id="previewImage" src="" alt="Hasil foto" class="rounded-lg border mx-auto w-64 shadow-md mb-2">
          <button type="button" id="deletePreviewBtn" class="bg-red-600 hover:bg-red-700 text-white px-4 py-1.5 rounded-lg text-sm transition">🗑 Hapus Foto</button>
        </div>
      </div>
