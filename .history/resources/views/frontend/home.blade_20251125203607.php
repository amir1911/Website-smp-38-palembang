...
<section class="bg-[#DCEBFA] text-[#1D4E89] py-16 sm:py-20 md:py-24 font-poppins relative overflow-hidden">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6 relative z-10">
        ...
        <!-- School Photo → MOBILE di atas -->
        <div class="flex justify-center order-1 lg:order-none" data-aos="fade-left" data-aos-delay="200">
        ...
        <!-- Text Content → MOBILE di bawah -->
        <div data-aos="fade-right" class="space-y-6 text-center lg:text-left order-2 lg:order-none">
