...
@section('content')
    ...
    @foreach ($ekstrakurikulers as $index => $item)
        <div class="flex-shrink-0 w-80 bg-white rounded-3xl shadow-xl p-5 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl snap-center"
            ...
            <!-- Foto -->
            <div class="rounded-2xl overflow-hidden h-56 mb-5 bg-white">
            ...
            <div x-data="{ open: false }">
                ...
                <!-- Deskripsi Pendek -->
                <p x-show="!open"
                   class="text-gray-700 text-center leading-relaxed text-sm">
                ...
                <button 
                    @click="open = !open"
                    class="mt-2 text-blue-600 font-semibold text-sm">
