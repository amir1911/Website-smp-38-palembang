...
<section class="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-[#DCEBFA] to-[#C8DFF7]">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 text-center">

    <!-- Judul -->
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-10"
        style="text-shadow: 0 3px 6px rgba(0,0,0,0.25);">
      Keunggulan Sekolah
    </h2>

    <!-- Wrapper Card -->
    <div class="bg-[#1D4E89] rounded-3xl px-6 sm:px-10 py-10 sm:py-14 shadow-xl">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div 
          ...
          class="flex flex-col items-center text-center p-6 sm:p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
          ...
          <!-- Judul -->
          <h3 class="text-[#1D4E89] font-semibold text-lg sm:text-xl mb-2">
            {{ $card['judul'] }}
          </h3>
