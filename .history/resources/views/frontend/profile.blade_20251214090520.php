    ...
    <div class="w-full px-6 md:px-12 lg:px-20 py-16 md:py-24 -mb-20"
        ...
        <div class="max-w-6xl mx-auto bg-white rounded-[30px] shadow-xl p-8 md:p-12">
            ...
            <div class="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
                ...
                <!-- Gambar sekolah -->
          <!-- Gambar sekolah -->
<div class="w-full md:w-[42%] flex items-center">
    <div class="w-full h-[260px] md:h-[300px] rounded-[16px] overflow-hidden shadow-md">
        <img src="{{ asset('storage/sekolah/smp38.png') }}"
