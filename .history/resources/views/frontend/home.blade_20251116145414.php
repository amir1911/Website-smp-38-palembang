    ...
    <div class="relative w-full">
        ...
        <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
            <div 
                ...
                class="relative w-full h-[260px] sm:h-[380px] md:h-[470px] lg:h-[550px] xl:h-[630px]
                ...
                <div class="absolute bottom-10 left-1/2 -translate-x-1/2">
                    <div class="backdrop-blur-xl bg-black/30 border border-white/10
                                px-6 py-3 rounded-2xl shadow-xl text-center max-w-2xl">
