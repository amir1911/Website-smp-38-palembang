...
<!-- ========================================
     KEUNGGULAN SEKOLAH
     ======================================== -->
<section class="py-12 sm:py-14 md:py-16 bg-[#DBEDFF]">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-10 text-[#1D4E89]" data-aos="fade-up">
            Keunggulan Sekolah
        </h2>

        <div class="bg-[#1D4E89] rounded-3xl px-8 sm:px-12 py-12 shadow-2xl">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div 
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-md mb-4 group-hover:scale-110 transition-transform duration-300">
                        <img 
