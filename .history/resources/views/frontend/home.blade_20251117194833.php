...
<div class="relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-[600px] xl:h-[650px] overflow-hidden">
    ...
    <template x-for="(item, index) in {{ $carousels->toJson() }}" :key="index">
        ...
        <div class="relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-[600px] xl:h-[650px]">
          ...
          <!-- CONTENT TEXT -->
<div class="absolute inset-0 flex items-start pt-16 sm:pt-24 md:pt-32 px-6 sm:px-8 md:px-12 lg:px-16">
    ...
    <div class="w-full max-w-7xl mx-auto">
        ...
        <div class="mb-3 sm:mb-4 animate-[slideInLeft_0.6s_ease-out]">
            <span class="inline-flex items-center space-x-2 bg-blue-500 text-white 
                         px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold shadow-lg">
        ...
        <div class="flex flex-wrap gap-3 sm:gap-4 mt-5 sm:mt-6">
            <button class="group bg-blue-600 hover:bg-blue-700 text-white font-semibold 
                           px-6 sm:px-8 py-2.5 rounded-lg transition-all hover:scale-105">
                Selengkapnya →
            </button>

            <button class="group bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white 
                           font-semibold px-5 sm:px-7 py-2.5 rounded-lg transition-all">
                Video Profil
            </button>
        </div>
        --}}
