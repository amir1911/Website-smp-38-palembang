...
<section class="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 sm:py-20 md:py-24 lg:py-32 font-[Poppins] overflow-hidden">
  
  <!-- Decorative Background Elements -->
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    <div class="absolute -top-24 -right-24 w-96 h-96 bg-blue-100 rounded-full opacity-20 blur-3xl"></div>
    <div class="absolute -bottom-24 -left-24 w-96 h-96 bg-cyan-100 rounded-full opacity-20 blur-3xl"></div>
  </div>

  <div class="relative max-w-7xl mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center px-4 sm:px-6 md:px-8">

    <!-- Kiri: Teks Profil -->
    <div data-aos="fade-right" data-aos-duration="800" class="text-center lg:text-left space-y-6">
      
      <!-- Badge -->
      <div class="inline-block">
        <span class="inline-flex items-center gap-2 bg-blue-100 text-blue-600 px-4 py-2 rounded-full text-sm font-semibold">
      ...
      <!-- Judul -->
      <div>
        <h2 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-blue-400 mb-2 leading-tight">

          SMP NEGERI 38
        </h2>
        <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-400 mb-4">
      ...
      <div class="flex items-center gap-3 justify-center lg:justify-start">
        <div class="h-1 w-12 bg-gradient-to-r from-blue-300 to-cyan-300 rounded-full"></div>
        <div class="h-1 w-24 bg-gradient-to-r from-blue-300 to-cyan-300 rounded-full"></div>
        <div class="h-1 w-12 bg-gradient-to-r from-blue-300 to-cyan-300 rounded-full"></div>
      </div>

      <!-- Deskripsi -->
      <p class="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
        SMP Negeri 38 Palembang merupakan sekolah unggulan berbasis 
        <span class="font-semibold text-gray-800 relative">
          Kurikulum Merdeka
         <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-300"></span>

        </span> 
        yang berkomitmen membentuk generasi berkarakter, mandiri, dan kreatif dalam menghadapi tantangan masa depan.
      </p>

      <!-- Button -->
      <div class="pt-2">
        <a href="/profile"
           class="group inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 text-base md:text-lg font-semibold">
          Selengkapnya
    ...
    <div class="flex justify-center mb-10 lg:mb-0" data-aos="zoom-in-up" data-aos-duration="800" data-aos-delay="200">
      <div class="relative group">
        ...
        <!-- Glow effect -->
        <div class="absolute inset-0 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-3xl blur-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
        
        <!-- Card Container -->
        <div class="relative bg-white/80 backdrop-blur-sm shadow-2xl rounded-3xl p-8 sm:p-10 md:p-12 border border-blue-100 group-hover:scale-105 transition-all duration-500">
          ...
          <img src="{{ asset('storage/logo/smp38palembang.jpg') }}" 
               ...
               class="w-[220px] sm:w-[280px] md:w-[360px] lg:w-[440px] h-auto object-contain mx-auto drop-shadow-xl animate-float">
          
          <!-- Label di bawah logo -->
          <div class="mt-6 text-center">
            <p class="text-sm font-semibold text-gray-700">SMP Negeri 38 Palembang</p>
...
<section class="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
 ...
 <!-- Statistik Sekolah -->
    <section class="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-gray-50 to-blue-50/30 relative overflow-hidden" id="statistik-section">
        <!-- Decorative Background Elements -->
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
            <div class="absolute top-20 left-10 w-72 h-72 bg-blue-200 rounded-full blur-3xl opacity-20"></div>
            <div class="absolute bottom-20 right-10 w-96 h-96 bg-cyan-200 rounded-full blur-3xl opacity-20"></div>
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-blue-100 to-cyan-100 rounded-full blur-3xl opacity-10"></div>
        </div>

        <div class="container mx-auto text-center px-4 sm:px-6 md:px-8 relative z-10">
            <!-- Judul -->
            <div class="mb-10 sm:mb-12 md:mb-14" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-3 tracking-wide bg-gradient-to-r from-[#49ADFF] to-[#2e8dd9] bg-clip-text text-transparent">
                    STATISTIK SEKOLAH
                </h2>
                <div class="w-24 h-1 bg-gradient-to-r from-[#49ADFF] to-[#2e8dd9] mx-auto rounded-full"></div>
            </div>

            <div class="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-10">
                <!-- Kartu Statistik: Guru -->
                <div class="bg-white rounded-full border-4 p-6 sm:p-8 flex flex-col items-center shadow-xl 
                            w-40 h-40 sm:w-48 sm:h-48 md:w-52 md:h-52 justify-center hover:scale-110 transition transform duration-300 hover:shadow-2xl card-pulse relative overflow-hidden group"
                     style="border-color: #49ADFF;"
                     data-aos="zoom-in"
                     data-aos-duration="800"
                     data-aos-delay="100">
                    <!-- Gradient overlay on hover -->
                    <div class="absolute inset-0 bg-gradient-to-br from-[#49ADFF]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></div>
                    
                    <img src="https://img.icons8.com/ios-filled/100/49ADFF/teacher.png" 
                         alt="Guru" class="mb-2 sm:mb-3 w-12 h-12 sm:w-16 sm:h-16 icon-float relative z-10">
                    <span class="text-3xl sm:text-4xl md:text-5xl font-extrabold counter relative z-10" 
                          style="color: #49ADFF;"
                          data-target="45">0</span>
                    <span class="text-base sm:text-lg md:text-xl text-gray-600 mt-1 font-semibold relative z-10">Guru</span>
                </div>
                ...
                <div class="bg-white rounded-full border-4 p-6 sm:p-8 flex flex-col items-center shadow-xl 
                    ...
                    <img src="https://img.icons8.com/ios-filled/100/49ADFF/student-male.png" 
                         alt="Siswa" class="mb-2 sm:mb-3 w-12 h-12 sm:w-16 sm:h-16 icon-float relative z-10">
                    <span class="text-3xl sm:text-4xl md:text-5xl font-extrabold counter relative z-10" 
                          style="color: #49ADFF;"
                          data-target="856">0</span>
                    <span class="text-base sm:text-lg md:text-xl text-gray-600 mt-1 font-semibold relative z-10">Siswa</span>
                </div>
                ...
                <div class="bg-white rounded-full border-4 p-6 sm:p-8 flex flex-col items-center shadow-xl 
                    ...
                    <img src="https://img.icons8.com/ios-filled/100/49ADFF/conference.png" 
                         alt="Staf" class="mb-2 sm:mb-3 w-12 h-12 sm:w-16 sm:h-16 icon-float relative z-10">
                    <span class="text-3xl sm:text-4xl md:text-5xl font-extrabold counter relative z-10" 
                          style="color: #49ADFF;"
                          data-target="28">0</span>
                    <span class="text-base sm:text-lg md:text-xl text-gray-600 mt-1 font-semibold relative z-10">Staf</span>
                </div>
            </div>
        </div>
