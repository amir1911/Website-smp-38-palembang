...
<head>
  ...
  <style>
    * {
    ...
    /* Social Button dengan tema biru */
    .social-btn {
      position: relative;
      overflow: hidden;
...
<header class="text-center py-16 px-4">
  <h1 class="text-3xl md:text-4xl font-extrabold shimmer-text mb-4">
...
<section class="container mx-auto px-4 md:px-6 pb-20">
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
    @foreach ($gurus as $guru)
      {{-- card yang sudah kamu buat --}}
      @include('partials._guru-card', ['guru' => $guru])
    @endforeach
  </div>
</section>
...
<header class="text-center py-16 px-4">
  <h1 class="text-3xl md:text-4xl font-extrabold shimmer-text mb-4">
    Staff SMP Negeri 38 Palembang
  </h1>
</header>

<section class="container mx-auto px-4 md:px-6 pb-20">
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
    @foreach ($staffs as $guru)
      {{-- gunakan desain card yang sama --}}
      @include('partials._guru-card', ['guru' => $guru])
    @endforeach
  </div>
</section>
