        ...
        <div data-aos="fade-up" 
          ...
          <div class="absolute top-4 left-4 z-20">
            @if($guru->kategori === 'Guru')
              <span class="category-badge badge-guru px-4 py-2 rounded-full text-white text-xs font-bold inline-flex items-center">
                <span class="badge-icon">
                  <i class="fas fa-graduation-cap text-xs"></i>
                </span>
                <span class="tracking-wide">GURU</span>
              </span>
            @else
              <span class="category-badge badge-staff px-4 py-2 rounded-full text-white text-xs font-bold inline-flex items-center">
                <span class="badge-icon">
                  <i class="fas fa-users-cog text-xs"></i>
                </span>
                <span class="tracking-wide">STAFF</span>
              </span>
            @endif
          </div>
