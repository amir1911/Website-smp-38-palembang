      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        @forelse ($gurus as $guru)
          <div data-aos="fade-up" 
               ...
               class="teacher-card rounded-3xl overflow-hidden shadow-xl">
...
<div class="p-6">
    ...
    @if ($guru->kategori === 'Guru' && $guru->nip)
        <div class="flex items-center justify-center gap-2 text-gray-700 text-xs font-semibold mb-2 bg-blue-50 px-3 py-1 rounded-full border border-blue-200 shadow-sm">
   ...
   <!-- Name -->
<h3 class="text-lg font-bold text-gray-800 mb-2 text-center capitalize hover:text-blue-600 transition-colors">
    {{ $guru->nama }}
</h3>

<!-- NIP -->
@if ($guru->kategori === 'Guru' && $guru->nip)
    <p class="text-center text-gray-600 text-xs font-semibold mb-3 bg-blue-50 px-3 py-1.5 inline-block rounded-full border border-blue-200 shadow-sm mx-auto">
