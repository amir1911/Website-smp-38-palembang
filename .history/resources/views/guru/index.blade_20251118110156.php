    ...
    <section class="container mx-auto px-4 md:px-6 pb-20">
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        @forelse ($gurus as $guru)
          <div 
    data-aos="fade-up"
    class="teacher-card rounded-3xl overflow-hidden shadow-xl relative">

    <!-- Badge Kategori di Atas Card -->
    <div class="absolute top-4 left-1/2 transform -translate-x-1/2 z-20">
        <span class="px-4 py-1.5 rounded-full text-white text-xs font-semibold shadow-lg
            {{ $guru->kategori === 'Guru' ? 'bg-blue-600' : 'bg-green-600' }}">
              ...
              {{-- <div class="absolute top-4 left-4">
                <div class="bg-white rounded-full px-3 py-1 shadow-lg">
                  <span class="text-blue-600 text-xs font-bold">
                    <i class="fas fa-star text-yellow-400"></i> Guru
                  </span>
                </div>
              </div> --}}
...
<div class="p-6">
  ...
  <!-- Name -->
<h3 class="text-lg font-bold text-gray-800 mb-1 text-center capitalize hover:text-blue-600 transition-colors">
    {{ $guru->nama }}
</h3>

<!-- NIP -->
@if ($guru->kategori === 'Guru' && $guru->nip)
    <p class="text-center text-gray-600 text-xs font-semibold mb-2 bg-blue-50 px-3 py-1.5 inline-block rounded-full border border-blue-200 shadow-sm mx-auto">
        <i class="fas fa-id-card text-blue-500 text-sm mr-1"></i>
        NIP: {{ $guru->nip }}
    </p>
@endif
...
<p class="text-center mb-3">
    <span class="inline-block px-4 py-1.5 rounded-full text-white text-xs font-semibold shadow-md
        {{ $guru->kategori === 'Guru' ? 'bg-blue-500' : 'bg-green-500' }}">
        <i class="fas fa-user-tag mr-1 text-xs"></i>
        {{ $guru->kategori }}
    </span>
</p>
    ...
    <div class="flex items-center justify-center gap-2 mb-3">
        ...
        <div class="w-1.5 h-1.5 bg-blue-500 rounded-full animate-pulse"></div>
              ...
              {{-- <!-- Location -->
              <div class="flex items-center justify-center gap-2 text-gray-600 mb-4 text-xs bg-blue-50 rounded-full px-3 py-1.5">
                <i class="fas fa-map-marker-alt text-blue-500 text-xs"></i>
                <span class="font-medium">Palembang</span>
              </div> --}}
