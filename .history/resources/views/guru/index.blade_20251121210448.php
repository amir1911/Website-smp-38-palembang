    ...
    <header class="text-center py-16 px-4">
      ...
      <div class="quote-card" data-aos="fade-up">
        <p class="text-gray-800 text-sm md:text-base leading-relaxed font-medium">
          <i class="fas fa-quote-left text-purple-400 mr-2 text-2xl"></i>
          ...
          <i class="fas fa-quote-right text-purple-400 ml-2 text-2xl"></i>
        </p>
      </div>
        ...
        @forelse ($gurus as $guru)
          <div class="teacher-card" 
            ...
            <div class="p-7 text-center">
              ...
              <!-- Divider -->
              <div class="w-16 h-1 bg-gradient-to-r from-purple-400 via-pink-500 to-purple-400 rounded-full mx-auto mb-5"></div>
        ...
        @empty
          ...
          <div class="col-span-full">
            <div class="teacher-card p-16 text-center" data-aos="fade-up">
              <div class="w-32 h-32 mx-auto bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center mb-6">
                <i class="fas fa-users-slash text-6xl text-purple-400"></i>
              </div>
