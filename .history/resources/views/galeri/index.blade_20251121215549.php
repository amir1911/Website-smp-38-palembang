...
<div 
            ...
            <template x-if="filteredItems.length">
                <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    ...
                    <template x-for="(item, index) in filteredItems" :key="item.id">
                        <div 
                            class="group relative overflow-hidden rounded-2xl cursor-pointer shadow-md hover:shadow-xl transform hover:scale-[1.02] transition-all"
                        ...
                        >
                            ...
                            <div class="relative overflow-hidden aspect-[4/3]">
                                ...
                                <!-- Gradient Hover -->
                                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-all"></div>
                                ...
                                <!-- 🔵 OVERLAY BIRU KETIKA DIKLIK -->
                                <div 
                                    x-show="showInfoIndex === index"
                                    x-transition
                                    class="absolute bottom-0 left-0 right-0 bg-[#4C8BBE]/80 text-white p-4 rounded-b-2xl shadow-lg"
                                >
    ...
    <!-- MODAL LIGHTBOX (tidak diubah, tetap sama) -->
    <div 
        x-show="modalOpen" 
        x-cloak
