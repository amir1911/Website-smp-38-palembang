            ...
            <template x-if="filteredItems.length">
                <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                    <template x-for="(item, index) in filteredItems" :key="item.id">
                        <div 
                            class="group relative overflow-hidden rounded-xl sm:rounded-2xl cursor-pointer transform hover:scale-[1.02] transition-all duration-500 shadow-lg hover:shadow-xl"
                        ...
                        >
                            ...
                            <div class="relative overflow-hidden aspect-[4/3]">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3 sm:p-4">
                                    <h3 class="text-white font-bold text-xs sm:text-sm md:text-base mb-0.5 line-clamp-1" x-text="item.judul"></h3>
                                    <p class="text-white/80 text-[10px] sm:text-xs line-clamp-1" x-text="item.deskripsi ?? 'Lihat detail'"></p>
                                </div>
                            </div>
                        </div>
                    </template>
