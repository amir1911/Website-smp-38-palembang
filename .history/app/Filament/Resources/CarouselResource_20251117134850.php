        ...
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('gambar')
                    ...
                    ->directory('carousel')
                    ->disk('public')
                    ->visibility('public')        // Wajib agar Filament bisa membaca file
                    ->image()
                    ->imageEditor()              // Fix preview & thumbnail
                    ->preserveFilenames()        // Mencegah error metadata
                    ->optimize('none')           // Jangan compress (fix waiting for size)
                    ->maxSize(4096)              // 4MB
                    ->required(),
