...
Route::get('/buku-tamu', [GuestController::class, 'index'])->name('buku-tamu.index');
Route::post('/buku-tamu', [GuestController::class, 'store'])->name('buku-tamu.store');




// Halaman utama Guru & Staff

Route::get('/guru', [GuruController::class, 'guru'])->name('guru.guru');
Route::get('/staff', [GuruController::class, 'staff'])->name('guru.staff');
